...
## Corpus Check
- 381 files · ~3,462,098 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3085 nodes · 6704 edges · 225 communities (147 shown, 78 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 89 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d9e8ccb1`
...
- `Bulk CSV Hard-match Dedup` --conceptually_related_to--> `handleUpload (multipart CSV POST)`  [INFERRED]
  CLAUDE.md → app/bulk-registration.tsx
...
## Communities (225 total, 78 thin omitted)

### Community 0 - "Admin Mobile Screens"
Cohesion: 0.04
Nodes (53): schoolHttp, useSchool(), BatchResult, BulkPaymentPage(), fmtRp(), RegistrationRow, BulkRegistrationPage(), Competition (+45 more)

### Community 1 - "School Auth Context"
Cohesion: 0.07
Nodes (53): commerceHttp, Certificate, ListResponse, CompOption, CountryRepsPage(), FORM_DEFAULTS, Rep, Order (+45 more)
...
Cohesion: 0.05
Nodes (55): env, errorHandler(), HttpError, authLimiter, bulkUploadLimiter, otpSendLimiter, otpVerifyLimiter, passwordResetLimiter (+47 more)

### Community 4 - "Database Columns & Keys"
Cohesion: 0.07
Nodes (46): DEFAULTS, marketingHttp, CHECK_TYPE_LABEL, CHECK_TYPE_OPTIONS, CheckType, FlowStep, FORM_DEFAULTS, Answer (+38 more)

### Community 5 - "Backend DB Bootstrap"
Cohesion: 0.08
Nodes (36): AnnouncementsPage(), { Provider, useHook }, CertificatesPage(), Props, ExamRow, ExamsListPage(), GradingQueuePage(), QueueRow (+28 more)

### Community 6 - "Admin / Audit Middleware"
Cohesion: 0.05
Nodes (46): main(), ansByQ, byNumber, chosen, CLEARED_REG, compId, correctPt, examId (+38 more)
...
Cohesion: 0.08
Nodes (35): FILTERS, adminHttp, competitionsApi, BrandPanel(), defaultCompetition, destinationFor(), goTo(), Mode (+27 more)
...
Cohesion: 0.07
Nodes (26): pool, ACCOUNTS, createTestAccounts(), main(), normalizePhone(), authMiddleware(), Request, cached (+18 more)

### Community 14 - "Registrations Routes"
Cohesion: 0.12
Nodes (29): CompetitionAdminLayout(), CompetitionAdminPage(), Announcement, AnnouncementCard(), CompetitionAnnouncementsPage(), fmtDate(), { Provider, useHook }, CompetitionCertificatesPage() (+21 more)
...
Cohesion: 0.07
Nodes (21): AnnouncementCard(), fmtDate(), styles, ExamResultScreen(), styles, sum(), styles, WINDOW_NOTE (+13 more)
...
Cohesion: 0.07
Nodes (35): compId, id, label, { limit, offset, page }, mapCertificate(), pageParams(), params, publicView() (+27 more)

### Community 20 - "Admin Routes (Backend)"
Cohesion: 0.07
Nodes (21): CompetitionDetailPage(), formatDate(), formatPrice(), Row(), STATUS_PILL, styles, CategoryAccent, CategoryBg (+13 more)

### Community 21 - "Legacy Vite/Express Stack"
Cohesion: 0.1
Nodes (36): announcement(), area(), demoCertificate(), exam(), localToday(), main(), material(), product() (+28 more)
...
Cohesion: 0.07
Nodes (23): CatalogCompetition, CompetitionCard(), fmtDate(), brandColors, chartColors, ColorRow, radii, statusColors (+15 more)
...
Cohesion: 0.08
Nodes (29): useIsMobile(), Sheet(), SheetContent(), SheetDescription(), SheetFooter(), SheetHeader(), SheetOverlay(), SheetTitle() (+21 more)

### Community 27 - "Parent Linking Flow"
Cohesion: 0.06
Nodes (32): certCompIfAccessible(), base, byId, codes, compId, discounted, id, imageUpload (+24 more)

### Community 28 - "Organizer Competition Forms"
Cohesion: 0.09
Nodes (24): certificatesHttp, countryRepHttp, httpFormData(), httpReq(), makeHttp(), questionBankHttp, schoolFetch(), schoolHttp (+16 more)

### Community 29 - "School Admin Routes"
Cohesion: 0.09
Nodes (19): styles, AuthTab, styles, AppInput(), AppInputProps, styles, INTEREST_CATEGORIES, InterestCategory (+11 more)
...
Cohesion: 0.15
Nodes (17): notificationsApi, schoolsApi, usersApi, PageHeader(), Pager(), Spinner(), Toast(), CATS (+9 more)

### Community 33 - "Express Bootstrap & Errors"
Cohesion: 0.08
Nodes (27): ReviewQuestionPage(), cn(), StatusBadge(), SchoolPendingPage(), Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup() (+19 more)
...
Cohesion: 0.12
Nodes (27): ALL_GRADES, CompSpec, main(), mc(), reset(), RESET_TABLES, RoundSpec, SECONDARY_GRADES (+19 more)
...
Cohesion: 0.09
Nodes (23): CATEGORIES, CompetitionForm(), CompetitionFormProps, CompetitionFormValues, DEFAULTS, STATUSES, CompetitionLogoUploader(), activationAdvice() (+15 more)
...
Cohesion: 0.09
Nodes (26): announcementRecipients(), announcementScopeIfAccessible(), assetUpload, bonus, code, compId, content, custom (+18 more)
...
Cohesion: 0.1
Nodes (12): AppUser, GradeLevel, MOCK_USER, UserRole, AuthContextType, AuthProvider(), mapProfile(), RegistrationStatus (+4 more)
...
Cohesion: 0.15
Nodes (14): metadata, UnifiedLogin(), AuthProvider(), HubAuthShell(), HubAuthShellProps, ThemeToggle(), ForgotPasswordPage(), ResetPasswordInner() (+6 more)
...
Cohesion: 0.15
Nodes (23): auth.signup, ChildrenScreen, config/api (API_BASE_URL), document.service, DocumentVaultScreen, historical.service, LinkParentScreen, Parent-Student PIN Invitation Flow (+15 more)
...
Cohesion: 0.11
Nodes (13): AuthContext, AuthCtx, { Provider, useHook }, NAV, Sidebar(), useAuth(), Dashboard(), DashboardPage() (+5 more)
...
Cohesion: 0.12
Nodes (15): Radius, MenuItem, ROLE_EMOJI, ROLE_ICON, ROLE_LABEL, styles, GeometricHeader, GeometricHeaderImpl() (+7 more)
...
Cohesion: 0.12
Nodes (9): navTheme, queryClient, RootLayout(), CertificateCard(), fmtDate(), styles, Surface, styles (+1 more)

### Community 64 - "Cluster 64"
Cohesion: 0.12
Nodes (14): AppShellProps, AppShellUser, NavItem, Separator(), SidebarContent(), SidebarFooter(), SidebarGroup(), SidebarGroupContent() (+6 more)
...
Cohesion: 0.12
Nodes (5): authApi, NAV, AuthContext, Ctx, LINKS

### Community 67 - "Cluster 67"
Cohesion: 0.21
Nodes (12): ExamPlayerScreen(), fmtClock(), styles, CATEGORY_LABEL, CompetitionRoundsScreen(), fmtDate(), Round, rupiah() (+4 more)
...
Cohesion: 0.13
Nodes (16): config/api API_BASE_URL, expo-notifications (external), k6-registration.js, loadtest README, MyRegistrationDetailsScreen, payments.service, Midtrans webhook handler, Push Notification Service (+8 more)
...
Cohesion: 0.14
Nodes (7): deleteNotification(), markAsRead(), Notification, NotificationsResponse, School, SchoolSearchParams, SchoolSearchResponse
...
Cohesion: 0.18
Nodes (8): organizerAuthApi, organizerCompetitionsApi, organizerProfileApi, organizerRegistrationsApi, organizerRevenueApi, registrationsApi, CATEGORIES, GRADE_LEVELS
...
Cohesion: 0.22
Nodes (8): emcHttp, fmtDate(), STATUS_STYLE, StorefrontOrder, ExamResultPage(), Section, SessionResult, sum()
...
Cohesion: 0.67
Nodes (3): ExamPlayerPage(), fmt(), SessionData
...
## Knowledge Gaps
- **1220 isolated node(s):** `{ defineConfig }`, `expoConfig`, `BulkJob`, `styles`, `queryClient` (+1215 more)
...
- **Why does `Button()` connect `Backend DB Bootstrap` to `Admin Mobile Screens`, `School Auth Context`, `Cluster 64`, `Express Bootstrap & Errors`, `Database Columns & Keys`, `Competitions CSV Seeder`, `Auth & Competitions Routes`, `CLAUDE.md Concepts`, `Registrations Routes`, `Push Notifications`, `Cluster 82`, `Teacher Mobile Flow`, `Cluster 56`, `Documents Backend`, `Cluster 123`, `Cluster 93`, `Cluster 94`, `Cluster 95`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `Card()` connect `Admin Mobile Screens` to `School Auth Context`, `Express Bootstrap & Errors`, `Database Columns & Keys`, `Backend DB Bootstrap`, `Competitions CSV Seeder`, `Auth & Competitions Routes`, `Auth Register Screen`, `CLAUDE.md Concepts`, `Registrations Routes`, `Mobile Auth Service`, `Cluster 93`, `Teacher Mobile Flow`, `Cluster 123`, `School Admin Routes`, `Cluster 94`, `Cluster 95`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `cn()` connect `Express Bootstrap & Errors` to `Admin Mobile Screens`, `School Auth Context`, `Cluster 64`, `Documents Backend`, `Database Columns & Keys`, `Backend DB Bootstrap`, `Cluster 69`, `Auth & Competitions Routes`, `Themed Components & Hooks`, `Auth Register Screen`, `Mobile Payments Service`, `Teacher Mobile Flow`, `Cluster 122`, `Cluster 123`, `Cluster 95`?**
