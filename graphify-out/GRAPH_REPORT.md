...
## Corpus Check
- 347 files · ~3,417,808 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2830 nodes · 5921 edges · 203 communities (130 shown, 73 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 97 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `63fe443b`
...
4. `Card()` - 67 edges
5. `Button()` - 65 edges
6. `PageHeader()` - 51 edges
7. `Sprint Plan (Full Roadmap)` - 48 edges
8. `Brand` - 47 edges
9. `getCompetitionConfig()` - 45 edges
10. `Badge()` - 44 edges
...
## Communities (203 total, 73 thin omitted)
...
Cohesion: 0.05
Nodes (52): schoolHttp, { Provider, useHook }, SchoolContext, SchoolCtx, schoolHttp, useSchool(), BatchResult, BulkPaymentPage() (+44 more)

### Community 2 - "Mobile API Service Layer"
Cohesion: 0.04
Nodes (59): mapOrder(), mapVoucherGroup(), pageParams(), productCompIfAccessible(), voucherGroupCompIfAccessible(), ansByQ, byNumber, chosen (+51 more)

### Community 3 - "Web Admin Layout"
Cohesion: 0.04
Nodes (37): CATEGORY_EMOJIS, CompetitionDetailPage(), formatDate(), formatPrice(), STATUS_PILL, STATUS_PILL_CFG, styles, CategoryAccent (+29 more)
...
Cohesion: 0.08
Nodes (35): CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS, fmtForInput(), FORM_DEFAULTS, CHECK_TYPE_LABEL (+27 more)

### Community 8 - "Auth & Competitions Routes"
Cohesion: 0.06
Nodes (28): pool, env, ACCOUNTS, main(), normalizePhone(), authMiddleware(), Request, cached (+20 more)
...
Cohesion: 0.06
Nodes (27): BulkJob, styles, Registration, School, Student, styles, Brand, Text (+19 more)

### Community 11 - "Auth & Twilio OTP"
Cohesion: 0.06
Nodes (23): AnnouncementCard(), fmtDate(), styles, ExamPlayerScreen(), fmtClock(), styles, styles, WINDOW_NOTE (+15 more)
...
Cohesion: 0.06
Nodes (32): ExamResultScreen(), styles, sum(), Elevation, Fonts, Motion, Radius, Shadow (+24 more)

### Community 16 - "Web UI Components"
Cohesion: 0.1
Nodes (23): FILTERS, ExamRow, QueueRow, Competition, STATUS_BADGE, STATUS_STYLE, ProctoringSession, Access (+15 more)
...
Cohesion: 0.08
Nodes (31): AnnouncementsPage(), commerceHttp, ExamsListPage(), GradingQueuePage(), ExamEditorPage(), ExamQuestion, GRADE_OPTIONS, LoadedExam (+23 more)

### Community 22 - "Web API Index"
Cohesion: 0.1
Nodes (25): CompetitionAdminPage(), EmcAdminPage(), PendingRow, StatusFilter, Announcement, AnnouncementCard(), CompetitionAnnouncementsPage(), fmtDate() (+17 more)

### Community 23 - "Teacher Mobile Flow"
Cohesion: 0.08
Nodes (24): schoolFetch(), BulkRegistrationPage(), Competition, CsvRow, JobStatus, STEPS, CatalogCompetition, CompetitionCard() (+16 more)
...
Cohesion: 0.06
Nodes (20): navTheme, queryClient, RootLayout(), HapticTab(), NotificationTabIcon(), NotificationTabIconProps, styles, Surface (+12 more)

### Community 27 - "Parent Linking Flow"
Cohesion: 0.15
Nodes (25): adminHttp, defaultCompetition, destinationFor(), goTo(), Mode, ROLES, RoleSelector(), UnifiedLogin() (+17 more)
...
Cohesion: 0.16
Nodes (16): CompetitionAdminLayout(), CompetitionAnnouncementsLayout(), { Provider, useHook }, competitionPaths(), defaultPortalConfig(), getCompetitionConfig(), CompetitionDashboardLayout(), CompetitionExamLayout() (+8 more)
...
Cohesion: 0.09
Nodes (19): questionMakerHttp, metadata, AuthContext, AuthCtx, AuthProvider(), { Provider, useHook }, useAuth(), createRoleAuth() (+11 more)
...
Cohesion: 0.13
Nodes (12): TYPES, STATUS_CLS, STATUS_STYLE, STATUSES, FORM_DEFAULTS, PageHeader(), Pager(), Spinner() (+4 more)
...
Cohesion: 0.14
Nodes (11): SchoolProvider(), NAV, QuestionBankProvider(), NAV, ADMIN_NAV, SchoolLayout(), SchoolLayoutInner(), TEACHER_NAV (+3 more)
...
Cohesion: 0.13
Nodes (14): useIsMobile(), AppShellProps, AppShellUser, NavItem, Separator(), SidebarContent(), SidebarFooter(), SidebarGroup() (+6 more)
...
Cohesion: 0.16
Nodes (12): CompetitionStudent, DashboardSummary, Deadline, getDashboardSummary(), getMyStudents(), getUpcomingDeadlines(), linkStudent(), Student (+4 more)
...
Cohesion: 0.14
Nodes (12): errorHandler(), HttpError, Province, provinces, regencies, Regency, router, verifySignedUrlToken() (+4 more)
...
Cohesion: 0.24
Nodes (6): BrandPanel(), Props, CompetitionPortalConfig, EMC, CompetitionPortalConfig, competitionRegistry
...
Cohesion: 0.15
Nodes (7): AccessInfo, AffiliatedCredential, AvailableExam, CheckType, FlowProgress, FlowProgressStep, StepStatus
...
Cohesion: 0.2
Nodes (6): Dashboard(), DashboardPage(), fmtRp(), Kpi, LINKS, QUICK_LINKS
...
Cohesion: 0.25
Nodes (8): publicView(), router, CertificatePdfData, COLOR, docToBuffer(), fmtDate(), fmtNum(), renderCertificatePdf()
...
## Knowledge Gaps
- **1158 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+1153 more)
...
- **Why does `Button()` connect `Teacher Mobile Flow` to `Web Auth API`, `School Auth Context`, `Admin / Audit Middleware`, `Web Auth Contexts`, `Beyond Classroom PDF`, `Cluster 73`, `Mobile API Plumbing`, `Parent Routes & Email`, `Web UI Components`, `Cluster 82`, `Legacy Vite/Express Stack`, `Web API Index`, `Cluster 85`, `Cluster 86`, `Cluster 56`, `Parent Linking Flow`, `School Admin Routes`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `Card()` connect `School Auth Context` to `Web Auth API`, `Admin / Audit Middleware`, `Web Auth Contexts`, `Beyond Classroom PDF`, `Cluster 73`, `Themed Components & Hooks`, `Parent Routes & Email`, `Web UI Components`, `Cluster 79`, `Cluster 82`, `Legacy Vite/Express Stack`, `Web API Index`, `Teacher Mobile Flow`, `Cluster 85`, `Cluster 86`, `School Admin Routes`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `cn()` connect `School Admin Routes` to `School Auth Context`, `Admin / Audit Middleware`, `Web Auth Contexts`, `Beyond Classroom PDF`, `Themed Components & Hooks`, `Mobile API Plumbing`, `Web UI Components`, `Cluster 82`, `Cluster 83`, `Reset Project Script`, `Legacy Vite/Express Stack`, `Cluster 86`, `Teacher Mobile Flow`, `Cluster 56`, `Parent Linking Flow`, `Cluster 63`?**
