...
## Corpus Check
- 353 files · ~3,423,147 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2875 nodes · 6055 edges · 207 communities (133 shown, 74 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 100 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `94c566df`
...
## Communities (207 total, 74 thin omitted)

### Community 0 - "Admin Mobile Screens"
Cohesion: 0.04
Nodes (47): AnnouncementCard(), fmtDate(), styles, ExamResultScreen(), styles, sum(), styles, styles (+39 more)

### Community 1 - "School Auth Context"
Cohesion: 0.04
Nodes (57): Registration, apiRequest(), RequestOptions, Certificate, getMine(), create(), Document, list() (+49 more)

### Community 2 - "Mobile API Service Layer"
Cohesion: 0.06
Nodes (45): FILTERS, schoolHttp, useSchool(), BulkRegistrationPage(), Competition, CsvRow, JobStatus, STEPS (+37 more)

### Community 3 - "Web Admin Layout"
Cohesion: 0.07
Nodes (37): CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS, fmtForInput(), FORM_DEFAULTS, TYPES (+29 more)
...
Cohesion: 0.08
Nodes (42): DEFAULTS, marketingHttp, questionBankHttp, { Provider, useHook }, CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS (+34 more)

### Community 6 - "Admin / Audit Middleware"
Cohesion: 0.07
Nodes (42): AnnouncementsPage(), commerceHttp, ExamsListPage(), GradingQueuePage(), QuestionEditorPage(), MaterialsPage(), DEFAULTS, Product (+34 more)

### Community 7 - "Web Auth Contexts"
Cohesion: 0.06
Nodes (42): env, authLimiter, otpSendLimiter, otpVerifyLimiter, passwordResetLimiter, pinVerifyLimiter, code, e164 (+34 more)

### Community 8 - "Auth & Competitions Routes"
Cohesion: 0.05
Nodes (32): pool, ACCOUNTS, main(), normalizePhone(), authMiddleware(), Request, bulkUploadLimiter, fileContent (+24 more)
...
Cohesion: 0.11
Nodes (25): Announcement, AnnouncementCard(), CompetitionAnnouncementsPage(), fmtDate(), certificatesHttp, emcHttp, CompetitionCertificatesPage(), MyCertificate (+17 more)
...
Cohesion: 0.14
Nodes (22): CompetitionAdminLayout(), CompetitionAnnouncementsLayout(), { Provider, useHook }, CompetitionCertificatesLayout(), BrandPanel(), Props, CompetitionPortalConfig, competitionPaths() (+14 more)
...
Cohesion: 0.06
Nodes (22): navTheme, queryClient, RootLayout(), styles, WINDOW_NOTE, Surface, AuthContextType, AuthProvider() (+14 more)
...
Cohesion: 0.1
Nodes (24): BatchResult, BulkPaymentPage(), fmtRp(), RegistrationRow, CatalogCompetition, CompetitionCard(), fmtDate(), ExamEditorPage() (+16 more)

### Community 27 - "Parent Linking Flow"
Cohesion: 0.08
Nodes (22): Certificate, CertificatesPage(), ListResponse, CHECK_TYPE_LABEL, CHECK_TYPE_OPTIONS, CheckType, FlowEditorDialog(), FlowStep (+14 more)
...
Cohesion: 0.11
Nodes (14): OrganizerProvider(), SchoolProvider(), NAV, NAV, OrganizerLayoutInner(), QuestionBankProvider(), NAV, ADMIN_NAV (+6 more)

### Community 41 - "Themed Components & Hooks"
Cohesion: 0.2
Nodes (19): defaultCompetition, destinationFor(), goTo(), Mode, ROLES, RoleSelector(), UnifiedLogin(), ArrowRightIcon() (+11 more)
...
Cohesion: 0.15
Nodes (14): adminHttp, metadata, AuthProvider(), HubAuthShell(), HubAuthShellProps, ThemeToggle(), ForgotPasswordPage(), ResetPasswordInner() (+6 more)
...
Cohesion: 0.13
Nodes (11): AuthContext, AuthCtx, { Provider, useHook }, useAuth(), NAV, Dashboard(), DashboardPage(), fmtRp() (+3 more)
...
Cohesion: 0.13
Nodes (9): authApi, NAV, Sidebar(), AuthContext, Ctx, useAuth(), DashboardLayout(), Login() (+1 more)
...
Cohesion: 0.13
Nodes (12): questionMakerHttp, schoolHttp, createRoleAuth(), Http, RoleAuthConfig, RoleAuthCtx, { Provider, useHook }, { Provider, useHook } (+4 more)
...
Cohesion: 0.17
Nodes (6): CompetitionAdminPage(), EmcAdminPage(), PendingRow, StatusFilter, { Provider, useHook }, EMC
...
Cohesion: 0.18
Nodes (12): config/api API_BASE_URL, expo-notifications (external), k6-registration.js, loadtest README, Push Notification Service, GET /:id/calendar.ics, GET /:id/completeness, registrations.routes.ts (+4 more)
...
## Knowledge Gaps
- **1176 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+1171 more)
...
- **Why does `Button()` connect `Documents Backend` to `Admin Mobile Screens`, `Mobile API Service Layer`, `Web Admin Layout`, `Cluster 100`, `Backend DB Bootstrap`, `Admin / Audit Middleware`, `Cluster 67`, `k6 Load Test`, `Themed Components & Hooks`, `Cluster 106`, `Push Notifications`, `Cluster 82`, `Web Competitions Page`, `Cluster 83`, `Legacy Vite/Express Stack`, `Document Vault Flow`, `Parent Linking Flow`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `cn()` connect `k6 Load Test` to `Cluster 65`, `Mobile API Service Layer`, `Web Admin Layout`, `Backend DB Bootstrap`, `Admin / Audit Middleware`, `Beyond Classroom PDF`, `Themed Components & Hooks`, `Cluster 105`, `Cluster 81`, `Cluster 82`, `Cluster 83`, `Competition Detail Mobile`, `Document Vault Flow`, `Documents Backend`, `Parent Linking Flow`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `Card()` connect `Documents Backend` to `Admin Mobile Screens`, `Mobile API Service Layer`, `Web Admin Layout`, `Cluster 100`, `Backend DB Bootstrap`, `Admin / Audit Middleware`, `Cluster 67`, `k6 Load Test`, `Cluster 106`, `Cluster 82`, `Web Competitions Page`, `Cluster 83`, `Legacy Vite/Express Stack`, `Competition Detail Mobile`, `Profile Edit & Interests`, `Parent Linking Flow`?**
