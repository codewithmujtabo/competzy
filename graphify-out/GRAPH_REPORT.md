...
## Corpus Check
- 353 files · ~3,422,862 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2872 nodes · 6051 edges · 205 communities (129 shown, 76 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 100 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0c0ce5a4`
...
1. `cn()` - 138 edges
2. `apiRequest` - 74 edges
3. `apiRequest()` - 72 edges
4. `Card()` - 69 edges
5. `Button()` - 67 edges
6. `PageHeader()` - 52 edges
7. `getCompetitionConfig()` - 49 edges
8. `Sprint Plan (Full Roadmap)` - 49 edges
9. `Brand` - 48 edges
10. `competitionPaths()` - 47 edges
...
## Communities (205 total, 76 thin omitted)

### Community 0 - "Admin Mobile Screens"
Cohesion: 0.04
Nodes (57): Registration, apiRequest(), RequestOptions, AuthResponse, getMe(), sendOtp(), sendPhoneOtp(), Certificate (+49 more)

### Community 1 - "School Auth Context"
Cohesion: 0.05
Nodes (51): AnnouncementsPage(), BatchResult, BulkPaymentPage(), fmtRp(), RegistrationRow, ExamsListPage(), GradingQueuePage(), QuestionEditorPage() (+43 more)

### Community 2 - "Mobile API Service Layer"
Cohesion: 0.07
Nodes (42): DEFAULTS, adminHttp, commerceHttp, marketingHttp, Certificate, CertificatesPage(), ListResponse, CHECK_TYPE_LABEL (+34 more)

### Community 3 - "Web Admin Layout"
Cohesion: 0.07
Nodes (38): FILTERS, schoolHttp, { Provider, useHook }, SchoolContext, SchoolCtx, schoolFetch(), schoolHttp, useSchool() (+30 more)

### Community 4 - "Database Columns & Keys"
Cohesion: 0.05
Nodes (37): pool, ACCOUNTS, main(), normalizePhone(), authMiddleware(), Request, fileContent, parsed (+29 more)

### Community 5 - "Backend DB Bootstrap"
Cohesion: 0.04
Nodes (51): requireRole(), certCompIfAccessible(), compId, id, label, { limit, offset, page }, mapCertificate(), pageParams() (+43 more)

### Community 6 - "Admin / Audit Middleware"
Cohesion: 0.07
Nodes (41): questionBankHttp, { Provider, useHook }, CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS, STATUSES, Answer (+33 more)

### Community 7 - "Web Auth Contexts"
Cohesion: 0.05
Nodes (34): CertificateCard(), fmtDate(), styles, ExamResultScreen(), styles, sum(), styles, WINDOW_NOTE (+26 more)

### Community 8 - "Auth & Competitions Routes"
Cohesion: 0.06
Nodes (41): authLimiter, bulkUploadLimiter, otpSendLimiter, otpVerifyLimiter, passwordResetLimiter, pinVerifyLimiter, code, e164 (+33 more)
...
Cohesion: 0.09
Nodes (28): CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS, fmtForInput(), FORM_DEFAULTS, FlowEditorDialog() (+20 more)
...
Cohesion: 0.04
Nodes (48): SPRINT 0 — Quick Wins ✅ COMPLETE, SPRINT 10 — Mobile Bug Fixes (May 6, 2026 Session 2) ✅ COMPLETE, SPRINT 11 — Bug Fixes (May 6, 2026 Session 3) ✅ COMPLETE, SPRINT 12 — Rebrand Kompetix → Competzy (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 13 — Production Infra Templates (May 9, 2026 Session 5) ✅ LOCAL ARTIFACTS DONE, SPRINT 14 — Compliance & Security Hardening (May 8–9, 2026 Sessions 4–5) ✅ COMPLETE, SPRINT 15 — Launch 1 Polish (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 16 — School Portal Soft Launch (May 9, 2026 Session 5) ✅ COMPLETE (+40 more)
...
Cohesion: 0.05
Nodes (37): schoolAdminOnly(), teacherOrSchoolAdmin(), actorRole, coveredOrderId, expectedSig, linkedIds, orderId, redirectToken (+29 more)
...
Cohesion: 0.07
Nodes (27): CATEGORY_EMOJIS, CompetitionDetailPage(), formatDate(), formatPrice(), STATUS_PILL, STATUS_PILL_CFG, styles, CategoryAccent (+19 more)
...
Cohesion: 0.14
Nodes (17): CompetitionAdminLayout(), CompetitionAnnouncementsLayout(), { Provider, useHook }, CompetitionCertificatesLayout(), competitionPaths(), competitionRegistry, defaultPortalConfig(), CompetitionDashboardLayout() (+9 more)

### Community 30 - "Analytics & Competition Detail"
Cohesion: 0.08
Nodes (29): mapProduct(), announcementRecipients(), announcementScopeIfAccessible(), assetUpload, bonus, code, compId, content (+21 more)

### Community 31 - "Auth Login & Profile Setup"
Cohesion: 0.08
Nodes (18): navTheme, queryClient, RootLayout(), AppUser, GradeLevel, MOCK_USER, UserRole, Surface (+10 more)

### Community 32 - "Web Auth API"
Cohesion: 0.08
Nodes (21): ExamEditorPage(), ExamQuestion, GRADE_OPTIONS, LoadedExam, ACTIONABLE, ACTIONABLE_STATUSES, Competition, Credential (+13 more)
...
Cohesion: 0.1
Nodes (17): AuthContext, AuthCtx, { Provider, useHook }, useAuth(), NAV, Sidebar(), useAuth(), DashboardLayout() (+9 more)

### Community 37 - "Competitions CSV Seeder"
Cohesion: 0.09
Nodes (26): ReviewQuestionPage(), cn(), StatusBadge(), SchoolPendingPage(), Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup() (+18 more)
...
Cohesion: 0.09
Nodes (12): AnnouncementCard(), fmtDate(), styles, styles, styles, styles, Tab, Announcement (+4 more)

### Community 41 - "Themed Components & Hooks"
Cohesion: 0.2
Nodes (18): defaultCompetition, destinationFor(), goTo(), Mode, ROLES, ArrowRightIcon(), base, EyeIcon() (+10 more)

### Community 42 - "Mobile API Plumbing"
Cohesion: 0.11
Nodes (14): styles, AuthTab, styles, AppInput(), AppInputProps, styles, INTEREST_CATEGORIES, InterestCategory (+6 more)
...
Cohesion: 0.1
Nodes (15): Radius, subjectColorFor(), IoniconName, styles, TYPE_EMOJI, TYPE_ICON, GeometricHeader, GeometricHeaderImpl() (+7 more)

### Community 49 - "Mobile Registrations Service"
Cohesion: 0.11
Nodes (12): certificatesHttp, questionMakerHttp, { Provider, useHook }, createRoleAuth(), Http, RoleAuthConfig, RoleAuthCtx, { Provider, useHook } (+4 more)

### Community 50 - "Mobile Auth Service"
Cohesion: 0.1
Nodes (13): organizerCompetitionsApi, CompetitionForm(), CompetitionFormValues, CATEGORIES, GRADE_LEVELS, Competition, CompetitionDetailPage(), fmtDate() (+5 more)
...
Cohesion: 0.14
Nodes (14): Shadow, CompetitionStudent, DashboardSummary, Deadline, getDashboardSummary(), getMyStudents(), getUpcomingDeadlines(), linkStudent() (+6 more)

### Community 54 - "Competition Detail Mobile"
Cohesion: 0.13
Nodes (15): metadata, RoleSelector(), UnifiedLogin(), AuthProvider(), HubAuthShell(), HubAuthShellProps, ThemeToggle(), ForgotPasswordPage() (+7 more)

### Community 55 - "Cluster 55"
Cohesion: 0.19
Nodes (20): announcement(), area(), demoCertificate(), exam(), localToday(), main(), material(), product() (+12 more)
...
Cohesion: 0.23
Nodes (14): authApi, notificationsApi, organizerAuthApi, organizerProfileApi, organizerRegistrationsApi, organizerRevenueApi, registrationsApi, Ctx (+6 more)
...
Cohesion: 0.16
Nodes (18): Analytics Wrapper, auth.login, auth.logout, auth.signup, auth.verifyOtp, auth.verifyPhoneOtp, Competzy Backend REST API (external), config/api API_BASE_URL (+10 more)
...
Cohesion: 0.15
Nodes (11): areaId, id, { limit, offset, page }, loadTestCenter(), mapTestCenter(), name, pageParams(), params (+3 more)
...
Cohesion: 0.17
Nodes (6): DOC_TYPES, Document, IoniconName, styles, Props, ScreenHeader
...
Cohesion: 0.29
Nodes (8): admin.service, AdminStudentsScreen, AuthContext Registration type (external), constants/api API_URL, MyRegistrationDetailsScreen, payments.service, Registration Service (legacy), registrations.service
...
## Knowledge Gaps
- **1173 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+1168 more)
...
- **Why does `Button()` connect `Web API Client` to `Web Auth API`, `School Auth Context`, `Mobile API Service Layer`, `Web Admin Layout`, `Cluster 68`, `Cluster 101`, `Admin / Audit Middleware`, `Web Auth Contexts`, `Cluster 102`, `Themed Components & Hooks`, `Competitions CSV Seeder`, `Mobile Registrations Service`, `Mobile Auth Service`, `Cluster 83`, `Admin Routes (Backend)`, `Document Vault Flow`, `School Admin Routes`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `Card()` connect `School Auth Context` to `Web Auth API`, `Mobile API Service Layer`, `Web Admin Layout`, `Cluster 68`, `Cluster 101`, `Admin / Audit Middleware`, `Web Auth Contexts`, `Cluster 102`, `Mobile Tabs Misc`, `Web API Client`, `Auth Register Screen`, `Competitions CSV Seeder`, `Mobile Registrations Service`, `Mobile Auth Service`, `Cluster 83`, `Document Vault Flow`, `School Admin Routes`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `cn()` connect `Competitions CSV Seeder` to `Web Auth API`, `School Auth Context`, `Mobile API Service Layer`, `Web Admin Layout`, `Cluster 67`, `Admin / Audit Middleware`, `Cluster 102`, `Themed Components & Hooks`, `Web API Client`, `Auth Register Screen`, `Mobile Auth Service`, `Cluster 82`, `Admin Routes (Backend)`, `Cluster 61`?**
