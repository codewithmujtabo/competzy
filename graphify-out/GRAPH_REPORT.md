# Graph Report - competzy  (2026-05-21)

## Corpus Check
- 405 files · ~3,491,302 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3244 nodes · 7112 edges · 277 communities (157 shown, 120 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 81 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a2d9fae7`
...
2. `Button()` - 89 edges
3. `Card()` - 87 edges
4. `apiRequest()` - 83 edges
5. `PageHeader()` - 65 edges
6. `Brand` - 63 edges
7. `Badge()` - 59 edges
8. `Sprint Plan (Full Roadmap)` - 57 edges
9. `Surface` - 53 edges
10. `Text` - 53 edges
...
- `Sidebar()` --calls--> `useAuth()`  [INFERRED]
  web/components/Sidebar.tsx → app/context/AuthContext.tsx
- `Login()` --calls--> `useAuth()`  [INFERRED]
  web/app/login/page.tsx → app/context/AuthContext.tsx
...
## Communities (277 total, 120 thin omitted)

### Community 0 - "Admin Mobile Screens"
Cohesion: 0.04
Nodes (43): pool, ACCOUNTS, createTestAccounts(), main(), normalizePhone(), compFilter(), liveFilter(), SOFT_DELETE_TABLES (+35 more)

### Community 1 - "School Auth Context"
Cohesion: 0.08
Nodes (38): FILTERS, schoolHttp, ExamRow, QueueRow, MedalRow, Competition, STATUS_BADGE, STATUS_STYLE (+30 more)

### Community 2 - "Mobile API Service Layer"
Cohesion: 0.05
Nodes (54): authLimiter, bulkUploadLimiter, otpSendLimiter, otpVerifyLimiter, passwordResetLimiter, pinVerifyLimiter, code, e164 (+46 more)

### Community 3 - "Web Admin Layout"
Cohesion: 0.04
Nodes (53): env, adminOrSchoolAdmin(), errorHandler(), HttpError, schoolAdminOnly(), teacherOrSchoolAdmin(), teacherOrAdminOnly(), next (+45 more)

### Community 4 - "Database Columns & Keys"
Cohesion: 0.07
Nodes (44): DEFAULTS, { Provider, useHook }, CHECK_TYPE_LABEL, CHECK_TYPE_OPTIONS, CheckType, FlowEditorDialog(), FlowStep, FORM_DEFAULTS (+36 more)

### Community 5 - "Backend DB Bootstrap"
Cohesion: 0.08
Nodes (34): countryRepHttp, Certificate, CertificatesPage(), ListResponse, CompOption, CountryRepsPage(), FORM_DEFAULTS, Rep (+26 more)

### Community 6 - "Admin / Audit Middleware"
Cohesion: 0.04
Nodes (56): SPRINT 0 — Quick Wins ✅ COMPLETE, SPRINT 10 — Mobile Bug Fixes (May 6, 2026 Session 2) ✅ COMPLETE, SPRINT 11 — Bug Fixes (May 6, 2026 Session 3) ✅ COMPLETE, SPRINT 12 — Rebrand Kompetix → Competzy (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 13 — Production Infra Templates (May 9, 2026 Session 5) ✅ LOCAL ARTIFACTS DONE, SPRINT 14 — Compliance & Security Hardening (May 8–9, 2026 Sessions 4–5) ✅ COMPLETE, SPRINT 15 — Launch 1 Polish (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 16 — School Portal Soft Launch (May 9, 2026 Session 5) ✅ COMPLETE (+48 more)

### Community 7 - "Web Auth Contexts"
Cohesion: 0.06
Nodes (28): BulkJob, styles, Registration, School, Student, styles, HapticTab(), NotificationTabIcon() (+20 more)

### Community 8 - "Auth & Competitions Routes"
Cohesion: 0.06
Nodes (29): ExamResultScreen(), styles, sum(), Shadow, Spacing, Text, styles, Tab (+21 more)
...
Cohesion: 0.06
Nodes (26): COLUMNS, EMPTY_ROW, isRowEmpty(), isValidRow(), ManualEntryGrid(), ManualRow, Props, Competition (+18 more)

### Community 13 - "Mobile App Bootstrap"
Cohesion: 0.08
Nodes (28): CompetitionDetailPage(), formatDate(), formatPrice(), Row(), STATUS_PILL, styles, CategoryAccent, CategoryBg (+20 more)

### Community 14 - "Registrations Routes"
Cohesion: 0.09
Nodes (32): AnnouncementsPage(), ExamsListPage(), GradingQueuePage(), ExamEditorPage(), ExamQuestion, GRADE_OPTIONS, LoadedExam, MaterialsPage() (+24 more)
...
Cohesion: 0.07
Nodes (30): CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS, fmtForInput(), FORM_DEFAULTS, CATEGORIES (+22 more)

### Community 17 - "Concept / Rationale Nodes"
Cohesion: 0.09
Nodes (39): announcement(), area(), demoCertificate(), exam(), localToday(), main(), material(), product() (+31 more)
...
Cohesion: 0.07
Nodes (23): styles, CheckoutState, IoniconName, ORDER_PAID, STATE_CONTENT, styles, styles, cap() (+15 more)

### Community 20 - "Admin Routes (Backend)"
Cohesion: 0.06
Nodes (32): GradeMultiSelect(), GradeMultiSelectProps, GRADES, ReviewQuestionPage(), cn(), StatusBadge(), SchoolPendingPage(), ExamPlayerPage() (+24 more)

### Community 21 - "Legacy Vite/Express Stack"
Cohesion: 0.08
Nodes (22): brandColors, chartColors, ColorRow, radii, statusColors, surfaceColors, TypeRow, typeScale (+14 more)
...
Cohesion: 0.09
Nodes (18): NAV, OrganizerProvider(), CountryRepLayout(), NAV, RepShell(), useIsMobile(), NAV, OrganizerLayoutInner() (+10 more)
...
Cohesion: 0.09
Nodes (29): apiRequest(), createOrder(), CreateOrderBody, getMyOrders(), getOrder(), getStorefrontProducts(), Order, OrderItem (+21 more)
...
Cohesion: 0.08
Nodes (23): { Provider, useHook }, SchoolContext, SchoolCtx, schoolFetch(), useSchool(), BatchResult, BulkPaymentPage(), fmtRp() (+15 more)

### Community 32 - "Web Auth API"
Cohesion: 0.09
Nodes (26): softDelete(), adminOnly(), audit(), requireRole(), email, fullName, localRound(), notFound (+18 more)

### Community 33 - "Express Bootstrap & Errors"
Cohesion: 0.07
Nodes (21): styles, AuthTab, styles, ALL_GRADES, Grade, GRADES, Role, ROLES (+13 more)
...
Cohesion: 0.1
Nodes (22): metadata, BrandPanel(), defaultCompetition, destinationFor(), goTo(), Mode, TAGLINES, UnifiedLogin() (+14 more)

### Community 36 - "Mobile Tabs Misc"
Cohesion: 0.12
Nodes (19): CompetitionAdminLayout(), CompetitionAdminPage(), Announcement, AnnouncementCard(), CompetitionAnnouncementsPage(), fmtDate(), { Provider, useHook }, competitionPaths() (+11 more)

### Community 37 - "Competitions CSV Seeder"
Cohesion: 0.08
Nodes (26): authMiddleware(), Request, cached, competitions, conditions, creature, now, recommendationsCache (+18 more)

### Community 38 - "Audit & Organizer Middleware"
Cohesion: 0.09
Nodes (16): AppUser, GradeLevel, MOCK_USER, UserRole, AuthContext, AuthContextType, AuthProvider(), mapProfile() (+8 more)

### Community 39 - "Competitions Routes & Recs"
Cohesion: 0.08
Nodes (25): compId, id, label, { limit, offset, page }, mapCertificate(), pageParams(), params, publicView() (+17 more)
...
Cohesion: 0.14
Nodes (16): EmcAdminPage(), PendingRow, StatusFilter, emcHttp, { Provider, useHook }, CompetitionCertificatesPage(), MyCertificate, EMC (+8 more)

### Community 42 - "Mobile API Plumbing"
Cohesion: 0.1
Nodes (23): main(), byExam, choiceQids, CLEARED, compId, deadline, examId, id (+15 more)

### Community 43 - "Auth Register Screen"
Cohesion: 0.1
Nodes (18): CompetitionStudent, DashboardSummary, Deadline, getDashboardSummary(), getMyCompetitions(), getMyStudents(), getUpcomingDeadlines(), linkStudent() (+10 more)

### Community 44 - "CLAUDE.md Concepts"
Cohesion: 0.07
Nodes (24): compIdFilter, conditions, csv, csvRows, data, headers, logoUpload, params (+16 more)
...
Cohesion: 0.19
Nodes (18): CATEGORY_LABEL, CompetitionRoundsScreen(), fmtDate(), Round, rupiah(), statusLabel(), statusTone(), styles (+10 more)

### Community 48 - "Profile Completion"
Cohesion: 0.18
Nodes (17): http, req(), token(), competitionsApi, notificationsApi, organizerAuthApi, organizerProfileApi, organizerRegistrationsApi (+9 more)

### Community 49 - "Mobile Registrations Service"
Cohesion: 0.08
Nodes (11): navTheme, queryClient, RootLayout(), styles, WINDOW_NOTE, styles, Surface, IoniconName (+3 more)

### Community 50 - "Mobile Auth Service"
Cohesion: 0.11
Nodes (15): Notif, NotifResponse, TYPE_ICON, ExamResultPage(), Section, SessionResult, sum(), fmtDateTime() (+7 more)
...
Cohesion: 0.23
Nodes (14): ArrowRightIcon(), base, EyeIcon(), EyeOffIcon(), LockIcon(), MailIcon(), MapPinIcon(), PhoneIcon() (+6 more)

### Community 54 - "Competition Detail Mobile"
Cohesion: 0.15
Nodes (17): backfillCertificates(), BestAttempt, CLEARED, DB, issueCertificateIfEligible(), IssueResult, makeVerificationCode(), initializeCronJobs() (+9 more)
...
Cohesion: 0.12
Nodes (12): INTEREST_CATEGORIES, InterestCategory, EMPTY_FORM, Field(), Form, StudentProfile, Avatar(), AvatarBadge() (+4 more)
...
Cohesion: 0.17
Nodes (9): usersApi, PageHeader(), Pager(), Spinner(), Toast(), CATS, EMPTY_FORM, ROLE_CLS (+1 more)

### Community 60 - "Cluster 60"
Cohesion: 0.13
Nodes (15): organizerHttp, OrganizerContext, OrganizerCtx, { Provider, useHook }, useOrganizer(), Activity, Competition, fmtRp() (+7 more)

### Community 61 - "Cluster 61"
Cohesion: 0.16
Nodes (11): STATUS_CLS, STATUS_STYLE, STATUSES, FORM_DEFAULTS, PageHeader(), Pager(), Spinner(), Toast() (+3 more)

### Community 62 - "Cluster 62"
Cohesion: 0.11
Nodes (16): description, end, ics, profileSnapshot, registrations, router, start, summary (+8 more)

### Community 63 - "Cluster 63"
Cohesion: 0.18
Nodes (13): ExamPlayerScreen(), fmtClock(), styles, Radius, GeometricHeader, GeometricHeaderImpl(), Palette, paletteColors() (+5 more)

### Community 64 - "Cluster 64"
Cohesion: 0.11
Nodes (15): ADMIN_QUICK, ADMIN_QUICK_LINKS, QuickLink, SchoolDashboard(), SchoolInfo, Stats, TEACHER_QUICK, TEACHER_QUICK_LINKS (+7 more)

### Community 65 - "Cluster 65"
Cohesion: 0.13
Nodes (9): authApi, NAV, Ctx, useAuth(), Dashboard(), DashboardPage(), fmtRp(), LINKS (+1 more)
...
Cohesion: 0.13
Nodes (9): DOC_TYPES, Document, IoniconName, styles, formatDateForDisplay(), ProfileEditScreen(), styles, Props (+1 more)
...
Cohesion: 0.14
Nodes (10): organizerCompetitionsApi, CompetitionForm(), Competition, CompetitionDetailPage(), fmtDate(), fmtRp(), formatCurrency(), STATUS_BADGE (+2 more)

### Community 72 - "Cluster 72"
Cohesion: 0.12
Nodes (10): Kpi, LINKS, QUICK_LINKS, QuickLink, TILE_BERRY, TILE_CITRUS, TILE_HORIZON, TILE_SKY (+2 more)
...
Cohesion: 0.18
Nodes (10): AuthContext, AuthCtx, AuthProvider(), { Provider, useHook }, useAuth(), NAV, Sidebar(), DashboardLayout() (+2 more)

### Community 75 - "Cluster 75"
Cohesion: 0.23
Nodes (11): adminHttp, certificatesHttp, commerceHttp, httpFormData(), httpReq(), makeHttp(), marketingHttp, questionBankHttp (+3 more)
...
Cohesion: 0.3
Nodes (10): AffiliatedAccess, create(), CreateParams, getCredentials(), getDetail(), list(), mapRow(), RegistrationDetail (+2 more)
...
Cohesion: 0.24
Nodes (9): BY_CODE, COUNTRIES, Country, countryByCode(), PRIORITY, PRIORITY_CODES, REST, CountrySelect() (+1 more)
...
Cohesion: 0.31
Nodes (7): BrandPanel(), TAGLINES, WORD_SLOTS, Props, CompetitionPortalConfig, CompetitionPortalConfig, competitionRegistry
...
Cohesion: 0.27
Nodes (6): { Provider, useHook }, createRoleAuth(), Http, RoleAuthConfig, RoleAuthCtx, { Provider, useHook }

### Community 100 - "Cluster 100"
Cohesion: 0.4
Nodes (8): resolveFileUrl(), Competition, get(), getRecommended(), list(), ListParams, mapRow(), trackView()
...
Cohesion: 0.22
Nodes (3): RequestOptions, Certificate, getMine()
...
Cohesion: 0.48
Nodes (5): getProfile(), updateProfile(), uploadPhoto(), uploadStudentCard(), UserProfile
...
Cohesion: 0.5
Nodes (3): AnnouncementCard(), fmtDate(), styles
...
## Knowledge Gaps
- **1277 isolated node(s):** `{ defineConfig }`, `expoConfig`, `BulkJob`, `styles`, `queryClient` (+1272 more)
...
- **Why does `Button()` connect `Mobile Auth Service` to `School Auth Context`, `Database Columns & Keys`, `Backend DB Bootstrap`, `Auth & Competitions Routes`, `Mobile Theme System`, `Registrations Routes`, `Web UI Components`, `Admin Routes (Backend)`, `Legacy Vite/Express Stack`, `Payments Backend`, `Parent Linking Flow`, `Analytics & Competition Detail`, `Auth Login & Profile Setup`, `Mobile Admin Service`, `Mobile Tabs Misc`, `Themed Components & Hooks`, `Profile Edit & Interests`, `Cluster 56`, `Cluster 61`, `Cluster 71`, `Cluster 92`, `Cluster 98`, `Cluster 114`, `Cluster 122`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `Card()` connect `School Auth Context` to `Database Columns & Keys`, `Backend DB Bootstrap`, `Auth & Competitions Routes`, `Mobile Theme System`, `Registrations Routes`, `Web UI Components`, `Admin Routes (Backend)`, `Legacy Vite/Express Stack`, `Payments Backend`, `Auth Login & Profile Setup`, `Mobile Tabs Misc`, `Themed Components & Hooks`, `Mobile Auth Service`, `Cluster 56`, `Cluster 60`, `Cluster 61`, `Cluster 64`, `Cluster 71`, `Cluster 72`, `Cluster 75`, `Cluster 92`, `Cluster 98`, `Cluster 114`, `Cluster 122`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `cn()` connect `Admin Routes (Backend)` to `School Auth Context`, `Database Columns & Keys`, `Backend DB Bootstrap`, `Mobile Theme System`, `Registrations Routes`, `Legacy Vite/Express Stack`, `Parent Linking Flow`, `Analytics & Competition Detail`, `Auth Login & Profile Setup`, `Mobile Admin Service`, `Mobile Auth Service`, `Cluster 56`, `Cluster 60`, `Cluster 61`, `Cluster 64`, `Cluster 65`, `Cluster 71`, `Cluster 72`, `Cluster 73`, `Cluster 92`, `Cluster 93`, `Cluster 97`?**
