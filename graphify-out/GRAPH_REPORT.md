...
## Corpus Check
- 361 files · ~3,426,928 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2950 nodes · 6208 edges · 219 communities (144 shown, 75 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 101 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a0203569`
...
Cohesion: 0.09
Nodes (47): DEFAULTS, commerceHttp, marketingHttp, Certificate, ListResponse, CATEGORIES, CATS, CompetitionsPage() (+39 more)

### Community 1 - "School Auth Context"
Cohesion: 0.07
Nodes (41): AnnouncementsPage(), schoolHttp, BatchResult, RegistrationRow, CertificatesPage(), ExamRow, ExamsListPage(), GradingQueuePage() (+33 more)
...
Cohesion: 0.06
Nodes (49): adminHttp, questionBankHttp, { Provider, useHook }, CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS, STATUSES (+41 more)
...
Cohesion: 0.04
Nodes (42): ansByQ, byNumber, chosen, CLEARED_REG, compId, correctPt, examId, grade (+34 more)
...
Cohesion: 0.06
Nodes (28): CertificateCard(), fmtDate(), styles, ExamPlayerScreen(), fmtClock(), ExamResultScreen(), styles, sum() (+20 more)
...
Cohesion: 0.11
Nodes (29): defaultCompetition, destinationFor(), goTo(), Mode, ROLES, RoleSelector(), UnifiedLogin(), ArrowRightIcon() (+21 more)
...
Cohesion: 0.12
Nodes (20): CompetitionAdminPage(), PendingRow, StatusFilter, Announcement, AnnouncementCard(), CompetitionAnnouncementsPage(), fmtDate(), certificatesHttp (+12 more)
...
Cohesion: 0.08
Nodes (17): styles, CheckoutState, IoniconName, ORDER_PAID, STATE_CONTENT, styles, styles, cap() (+9 more)

### Community 31 - "Auth Login & Profile Setup"
Cohesion: 0.07
Nodes (16): navTheme, queryClient, RootLayout(), AppUser, GradeLevel, MOCK_USER, UserRole, Surface (+8 more)
...
Cohesion: 0.1
Nodes (15): Competition, CsvRow, JobStatus, STEPS, Competition, STATUS_BADGE, STATUS_STYLE, GradingSession (+7 more)
...
Cohesion: 0.09
Nodes (27): ReviewQuestionPage(), cn(), StatusBadge(), ExamPlayerPage(), fmt(), Avatar(), AvatarBadge(), AvatarFallback() (+19 more)

### Community 37 - "Competitions CSV Seeder"
Cohesion: 0.09
Nodes (23): CompSpec, main(), mc(), reset(), RESET_TABLES, seedCompetition(), SeedQuestion, SPECS (+15 more)
...
Cohesion: 0.11
Nodes (16): AuthContext, AuthCtx, { Provider, useHook }, useAuth(), NAV, Sidebar(), useAuth(), DashboardLayout() (+8 more)
...
Cohesion: 0.09
Nodes (17): AnnouncementCard(), fmtDate(), styles, Radius, subjectColorFor(), Slide, slides, styles (+9 more)
...
Cohesion: 0.1
Nodes (17): ExamEditorPage(), ExamQuestion, GRADE_OPTIONS, LoadedExam, ACTIONABLE, ACTIONABLE_STATUSES, Competition, Credential (+9 more)
...
Cohesion: 0.12
Nodes (14): FILTERS, Competition, Registration, STATUS_CLS, STATUS_STYLE, STATUS_TABS, Tabs(), TabsList() (+6 more)
...
Cohesion: 0.14
Nodes (11): TYPES, STATUS_CLS, STATUS_STYLE, STATUSES, PageHeader(), Pager(), Spinner(), Toast() (+3 more)
...
Cohesion: 0.14
Nodes (9): EmcAdminPage(), questionMakerHttp, { Provider, useHook }, createRoleAuth(), Http, RoleAuthConfig, RoleAuthCtx, { Provider, useHook } (+1 more)
...
Cohesion: 0.14
Nodes (5): Certificate, getMine(), getProfile(), updateProfile(), UserProfile
...
Cohesion: 0.32
Nodes (5): fmt(), fmtRp(), Revenue(), RevenueData, RevenuePage()
...
Cohesion: 0.5
Nodes (3): metadata, AuthProvider(), Toaster()
...
## Knowledge Gaps
- **1206 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+1201 more)
...
- **Why does `Button()` connect `k6 Load Test` to `Admin Mobile Screens`, `School Auth Context`, `Cluster 66`, `Web Admin Layout`, `Mobile Tabs Misc`, `Auth Register Screen`, `Historical Phone Login`, `Cluster 92`, `Cluster 112`, `Web UI Components`, `Web Competitions Page`, `Reset Project Script`, `Cluster 118`, `Cluster 119`, `Web API Index`, `Organizer Competition Forms`, `Cluster 93`, `Cluster 63`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `Card()` connect `School Auth Context` to `Admin Mobile Screens`, `Web Admin Layout`, `Admin Routes (Backend)`, `Web API Index`, `Organizer Competition Forms`, `k6 Load Test`, `Mobile Tabs Misc`, `Competitions Routes & Recs`, `Auth Register Screen`, `CLAUDE.md Concepts`, `Historical Phone Login`, `Reset Project Script`, `Cluster 63`, `Cluster 66`, `Cluster 92`, `Cluster 93`, `Cluster 101`, `Cluster 112`, `Cluster 118`, `Cluster 119`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `Brand` connect `Mobile API Plumbing` to `Express Bootstrap & Errors`, `Cluster 99`, `Auth & Competitions Routes`, `Themed Components & Hooks`, `Cron & Background Jobs`, `Cluster 104`, `Mobile App Bootstrap`, `Cluster 115`, `Profile Edit & Interests`, `Competition Detail Mobile`, `Cluster 95`, `Cluster 63`, `Analytics & Competition Detail`, `Auth Login & Profile Setup`?**
