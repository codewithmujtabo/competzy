...
## Corpus Check
- 364 files · ~3,428,948 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2975 nodes · 6290 edges · 209 communities (135 shown, 74 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 101 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `99a2e239`
...
## Communities (209 total, 74 thin omitted)
...
Cohesion: 0.05
Nodes (53): Certificate, CertificatesPage(), ListResponse, CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS (+45 more)

### Community 2 - "Mobile API Service Layer"
Cohesion: 0.04
Nodes (47): ExamResultScreen(), styles, sum(), Radius, Shadow, Spacing, Text, Type (+39 more)

### Community 3 - "Web Admin Layout"
Cohesion: 0.07
Nodes (50): DEFAULTS, marketingHttp, questionBankHttp, { Provider, useHook }, CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS (+42 more)

### Community 4 - "Database Columns & Keys"
Cohesion: 0.07
Nodes (36): schoolHttp, Competition, CsvRow, JobStatus, STEPS, ExamRow, QueueRow, Competition (+28 more)

### Community 5 - "Backend DB Bootstrap"
Cohesion: 0.04
Nodes (48): compFilter(), liveFilter(), SOFT_DELETE_TABLES, softDelete(), adminOnly(), audit(), AuditOptions, REDACT_KEYS (+40 more)

### Community 6 - "Admin / Audit Middleware"
Cohesion: 0.04
Nodes (52): requireRole(), certCompIfAccessible(), compId, id, label, { limit, offset, page }, mapCertificate(), pageParams() (+44 more)

### Community 7 - "Web Auth Contexts"
Cohesion: 0.08
Nodes (37): BatchResult, RegistrationRow, QuestionBankDashboard(), QuestionRow, QuestionRow, STATUS_STYLE, Subject, CompetitionStudent (+29 more)
...
Cohesion: 0.05
Nodes (34): pool, env, ACCOUNTS, main(), normalizePhone(), authMiddleware(), Request, cached (+26 more)
...
Cohesion: 0.05
Nodes (27): navTheme, queryClient, RootLayout(), styles, CheckoutState, IoniconName, ORDER_PAID, STATE_CONTENT (+19 more)
...
Cohesion: 0.05
Nodes (36): questionMakerHttp, schoolHttp, createRoleAuth(), Http, RoleAuthConfig, RoleAuthCtx, { Provider, useHook }, { Provider, useHook } (+28 more)
...
Cohesion: 0.1
Nodes (22): CompetitionAdminPage(), EmcAdminPage(), FILTERS, PendingRow, StatusFilter, Announcement, AnnouncementCard(), CompetitionAnnouncementsPage() (+14 more)
...
Cohesion: 0.08
Nodes (25): AnnouncementsPage(), commerceHttp, ExamsListPage(), GradingQueuePage(), QuestionEditorPage(), MaterialsPage(), Order, OrderItem (+17 more)
...
Cohesion: 0.09
Nodes (25): announcementRecipients(), announcementScopeIfAccessible(), assetUpload, bonus, code, compId, content, custom (+17 more)
...
Cohesion: 0.08
Nodes (15): AppUser, GradeLevel, MOCK_USER, UserRole, AuthContextType, AuthProvider(), Registration, RegistrationStatus (+7 more)
...
Cohesion: 0.13
Nodes (16): organizerHttp, OrganizerContext, OrganizerCtx, OrganizerProvider(), { Provider, useHook }, useOrganizer(), Activity, Competition (+8 more)
...
Cohesion: 0.18
Nodes (5): Kpi, LINKS, QUICK_LINKS, ChartCard(), ChartCardProps
...
## Knowledge Gaps
- **1216 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+1211 more)
...
- **Why does `Button()` connect `Web Auth Contexts` to `Express Bootstrap & Errors`, `Mobile API Service Layer`, `Web Admin Layout`, `Database Columns & Keys`, `School Auth Context`, `Cluster 101`, `Cluster 71`, `Mobile Tabs Misc`, `Cluster 106`, `Cluster 107`, `Web Competitions Page`, `Cluster 83`, `Legacy Vite/Express Stack`, `Profile Edit & Interests`, `Cluster 86`, `Payments Backend`, `Organizer Competition Forms`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `Card()` connect `Web Auth Contexts` to `Express Bootstrap & Errors`, `Mobile API Service Layer`, `Web Admin Layout`, `Database Columns & Keys`, `School Auth Context`, `Cluster 101`, `Cluster 71`, `Mobile Tabs Misc`, `Cluster 106`, `Cluster 107`, `Web UI Components`, `Profile Completion`, `Cluster 80`, `Cluster 83`, `Legacy Vite/Express Stack`, `Profile Edit & Interests`, `Cluster 86`, `Payments Backend`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `cn()` connect `Mobile Tabs Misc` to `School Auth Context`, `Express Bootstrap & Errors`, `Web Admin Layout`, `Database Columns & Keys`, `Web Auth Contexts`, `Cluster 80`, `Web UI Components`, `Cluster 82`, `Web Competitions Page`, `Cluster 84`, `Cluster 81`, `Cluster 86`, `Organizer Competition Forms`, `Cluster 62`?**
