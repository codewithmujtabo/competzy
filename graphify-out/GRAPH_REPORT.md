...
## Corpus Check
- 379 files · ~3,459,177 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3030 nodes · 6304 edges · 238 communities (160 shown, 78 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 89 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `37d3ed15`
...
1. `cn()` - 142 edges
2. `apiRequest()` - 79 edges
3. `Card()` - 78 edges
4. `Button()` - 76 edges
5. `apiRequest` - 63 edges
6. `PageHeader()` - 58 edges
7. `Brand` - 54 edges
8. `Badge()` - 54 edges
9. `Sprint Plan (Full Roadmap)` - 51 edges
10. `Skeleton()` - 49 edges
...
- `DashboardLayout()` --calls--> `useAuth()`  [INFERRED]
  app/(dashboard)/layout.tsx → context/AuthContext.tsx
- `Sidebar()` --calls--> `useAuth()`  [INFERRED]
  web/components/Sidebar.tsx → context/AuthContext.tsx
- `Login()` --calls--> `useAuth()`  [INFERRED]
  web/app/login/page.tsx → context/AuthContext.tsx
- `main()` --calls--> `mc()`  [INFERRED]
  backend/src/db/seed-emc-demo.ts → db/seed-test-competitions.ts
...
## Communities (238 total, 78 thin omitted)

### Community 0 - "Admin Mobile Screens"
Cohesion: 0.09
Nodes (35): FILTERS, Certificate, ListResponse, ExamRow, QueueRow, MedalRow, Competition, STATUS_BADGE (+27 more)

### Community 1 - "School Auth Context"
Cohesion: 0.08
Nodes (44): DEFAULTS, marketingHttp, questionBankHttp, { Provider, useHook }, CHECK_TYPE_LABEL, CHECK_TYPE_OPTIONS, CheckType, FlowEditorDialog() (+36 more)

### Community 2 - "Mobile API Service Layer"
Cohesion: 0.07
Nodes (36): certificatesHttp, commerceHttp, countryRepHttp, schoolHttp, CompOption, FORM_DEFAULTS, Rep, ACTIONABLE (+28 more)

### Community 3 - "Web Admin Layout"
Cohesion: 0.05
Nodes (32): pool, ACCOUNTS, main(), normalizePhone(), authMiddleware(), Request, cached, competitions (+24 more)

### Community 4 - "Database Columns & Keys"
Cohesion: 0.06
Nodes (29): AnnouncementCard(), fmtDate(), styles, CertificateCard(), fmtDate(), styles, ExamPlayerScreen(), fmtClock() (+21 more)
...
Cohesion: 0.06
Nodes (37): errorHandler(), HttpError, router, token, category, conditions, params, router (+29 more)

### Community 9 - "Cron & Background Jobs"
Cohesion: 0.06
Nodes (32): { Provider, useHook }, SchoolContext, SchoolCtx, schoolFetch(), schoolHttp, useSchool(), BatchResult, BulkPaymentPage() (+24 more)

### Community 10 - "Web API Client"
Cohesion: 0.08
Nodes (34): AnnouncementsPage(), CertificatesPage(), ExamsListPage(), GradingQueuePage(), QuestionEditorPage(), MaterialsPage(), PaperExamsPage(), ProctoringPage() (+26 more)
...
Cohesion: 0.05
Nodes (24): CompetitionDetailPage(), formatDate(), formatPrice(), STATUS_PILL, styles, CategoryAccent, CategoryBg, CategoryEmoji (+16 more)

### Community 13 - "Mobile App Bootstrap"
Cohesion: 0.05
Nodes (32): compFilter(), liveFilter(), SOFT_DELETE_TABLES, CHECK_TYPES, CheckType, compId, FlowStep, loadFlow() (+24 more)
...
Cohesion: 0.08
Nodes (27): CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS, fmtForInput(), FORM_DEFAULTS, Order (+19 more)
...
Cohesion: 0.06
Nodes (26): Radius, Shadow, styles, Tab, MenuItem, ROLE_EMOJI, ROLE_ICON, ROLE_LABEL (+18 more)
...
Cohesion: 0.06
Nodes (35): ALL_GRADES, CompSpec, main(), mc(), reset(), RESET_TABLES, RoundSpec, SECONDARY_GRADES (+27 more)
...
Cohesion: 0.07
Nodes (31): mapProduct(), announcementRecipients(), announcementScopeIfAccessible(), assetUpload, bonus, code, compId, content (+23 more)
...
Cohesion: 0.07
Nodes (31): GradeMultiSelect(), GradeMultiSelectProps, GRADES, ReviewQuestionPage(), cn(), StatusBadge(), SchoolPendingPage(), ExamPlayerPage() (+23 more)

### Community 26 - "Documents Backend"
Cohesion: 0.09
Nodes (27): softDelete(), adminOnly(), audit(), AuditOptions, REDACT_KEYS, requireRole(), email, fullName (+19 more)
...
Cohesion: 0.14
Nodes (22): ArrowRightIcon(), base, EyeIcon(), EyeOffIcon(), LockIcon(), MailIcon(), MapPinIcon(), PhoneIcon() (+14 more)

### Community 30 - "Analytics & Competition Detail"
Cohesion: 0.12
Nodes (30): announcement(), area(), demoCertificate(), exam(), localToday(), main(), material(), product() (+22 more)
...
Cohesion: 0.07
Nodes (25): schoolAdminOnly(), teacherOrSchoolAdmin(), teacherOrAdminOnly(), next, actorRole, coveredOrderId, expectedSig, linkedIds (+17 more)
...
Cohesion: 0.09
Nodes (16): styles, CheckoutState, IoniconName, ORDER_PAID, STATE_CONTENT, styles, cap(), fmtDate() (+8 more)

### Community 36 - "Mobile Tabs Misc"
Cohesion: 0.13
Nodes (14): TYPES, STATUS_CLS, STATUS_STYLE, STATUSES, FORM_DEFAULTS, Button(), buttonVariants, PageHeader() (+6 more)
...
Cohesion: 0.1
Nodes (18): CATEGORIES, CompetitionFormProps, CompetitionFormValues, DEFAULTS, STATUSES, CompetitionLogoUploader(), Props, DATE_FIELDS (+10 more)

### Community 39 - "Competitions Routes & Recs"
Cohesion: 0.15
Nodes (16): CompetitionAdminLayout(), Announcement, AnnouncementCard(), CompetitionAnnouncementsPage(), fmtDate(), { Provider, useHook }, competitionPaths(), getCompetitionConfig() (+8 more)

### Community 40 - "Beyond Classroom PDF"
Cohesion: 0.09
Nodes (22): compId, id, label, { limit, offset, page }, mapCertificate(), pageParams(), params, publicView() (+14 more)

### Community 41 - "Themed Components & Hooks"
Cohesion: 0.15
Nodes (18): CompetitionAdminPage(), EmcAdminPage(), PendingRow, StatusFilter, emcHttp, CompetitionCertificatesPage(), MyCertificate, PortalCompetition (+10 more)
...
Cohesion: 0.11
Nodes (13): SchoolProvider(), NAV, DashboardLayout(), NAV, QuestionBankProvider(), NAV, ADMIN_NAV, SchoolLayout() (+5 more)

### Community 44 - "CLAUDE.md Concepts"
Cohesion: 0.08
Nodes (22): adminOrSchoolAdmin(), compIdFilter, conditions, csv, csvRows, data, headers, logoUpload (+14 more)
...
Cohesion: 0.09
Nodes (12): AccessInfo, AffiliatedCredential, AvailableExam, CheckType, EmcDashboardPage(), FlowProgress, FlowProgressStep, MyCertificate (+4 more)
...
Cohesion: 0.11
Nodes (14): brandColors, chartColors, ColorRow, radii, statusColors, surfaceColors, TypeRow, typeScale (+6 more)
...
Cohesion: 0.14
Nodes (10): { Provider, useHook }, BrandPanel(), TAGLINES, WORD_SLOTS, Props, CompetitionPortalConfig, EMC, CompetitionPortalConfig (+2 more)

### Community 53 - "Profile Edit & Interests"
Cohesion: 0.23
Nodes (14): competitionsApi, notificationsApi, organizerAuthApi, organizerProfileApi, organizerRegistrationsApi, organizerRevenueApi, registrationsApi, schoolsApi (+6 more)
...
Cohesion: 0.13
Nodes (11): styles, AuthTab, styles, AppInput(), AppInputProps, styles, Surface, styles (+3 more)
...
Cohesion: 0.12
Nodes (13): authLimiter, otpSendLimiter, otpVerifyLimiter, passwordResetLimiter, pinVerifyLimiter, code, e164, email (+5 more)

### Community 58 - "Cluster 58"
Cohesion: 0.11
Nodes (11): Certificate, getMine(), createManualIntent(), createSnapToken(), getPostPaymentRedirectUrl(), ManualPaymentIntent, PayerKind, SnapTokenResponse (+3 more)
...
Cohesion: 0.12
Nodes (11): AuthContext, AuthContextType, Registration, RegistrationStatus, AffiliatedAccess, create(), CreateParams, getCredentials() (+3 more)
...
Cohesion: 0.15
Nodes (8): useAuth(), Dashboard(), DashboardPage(), fmtRp(), Kpi, LINKS, QUICK_LINKS, LINKS

### Community 71 - "Cluster 71"
Cohesion: 0.14
Nodes (7): authApi, navTheme, queryClient, RootLayout(), NAV, AuthProvider(), Ctx
...
Cohesion: 0.17
Nodes (10): metadata, AuthContext, AuthCtx, AuthProvider(), { Provider, useHook }, useAuth(), NAV, Sidebar() (+2 more)
...
Cohesion: 0.14
Nodes (13): allRows, conditions, countParams, csv, csvRows, doc, limitNum, normalizedData (+5 more)

### Community 79 - "Cluster 79"
Cohesion: 0.26
Nodes (12): hashPassword(), CsvRow, ProcessingError, processJob(), processPendingJobs(), processRow(), isSmtpConfigured(), sendMailOrThrow() (+4 more)
...
Cohesion: 0.24
Nodes (9): Elevation, Fonts, Motion, subjectColorFor(), SubjectColors, pickLetter(), Props, SubjectCircle (+1 more)
...
Cohesion: 0.18
Nodes (8): childrenMap, expiresAt, normalizedEmail, params, pin, router, smtpReady, studentColumns

### Community 94 - "Cluster 94"
Cohesion: 0.18
Nodes (6): adminHttp, Access, Competition, GRADES, QuestionMaker, Segment
...
Cohesion: 0.25
Nodes (7): RequestOptions, resolveFileUrl(), Announcement, getAnnouncements(), getMaterials(), Material, sendSuggestion()
...
Cohesion: 0.25
Nodes (4): CATEGORY_LABEL, Round, rupiah(), styles
...
Cohesion: 0.25
Nodes (7): defaultCompetition, destinationFor(), goTo(), Mode, TAGLINES, UnifiedLogin(), WORD_SLOTS
...
Cohesion: 0.29
Nodes (4): AppUser, GradeLevel, MOCK_USER, UserRole
...
Cohesion: 0.43
Nodes (6): CertificatePdfData, COLOR, docToBuffer(), fmtDate(), fmtNum(), renderCertificatePdf()

### Community 115 - "Cluster 115"
Cohesion: 0.29
Nodes (6): bulkUploadLimiter, fileContent, parsed, router, upload, parseAndValidateCsv()

### Community 116 - "Cluster 116"
Cohesion: 0.33
Nodes (4): env, comparePassword(), generateOtp(), generateToken()
...
Cohesion: 0.33
Nodes (3): getProfile(), updateProfile(), UserProfile
...
Cohesion: 0.8
Nodes (4): getClient(), sendPhoneOtp(), toE164(), verifyPhoneOtp()
...
## Knowledge Gaps
- **1233 isolated node(s):** `CATEGORY_LABEL`, `styles`, `STATUS_PILL`, `styles`, `RegistrationStatus` (+1228 more)
...
- **Why does `Button()` connect `Mobile Tabs Misc` to `Admin Mobile Screens`, `School Auth Context`, `Mobile API Service Layer`, `Cluster 129`, `Cluster 130`, `Cron & Background Jobs`, `Web API Client`, `Parent Routes & Email`, `Concept / Rationale Nodes`, `Mobile Doc & User Services`, `Document Vault Flow`, `School Admin Routes`, `Audit & Organizer Middleware`, `Competitions Routes & Recs`, `Themed Components & Hooks`, `Push Notifications`, `Mobile Registrations Service`, `Cluster 67`, `Cluster 94`, `Cluster 97`, `Cluster 102`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `Card()` connect `Web API Client` to `Admin Mobile Screens`, `School Auth Context`, `Mobile API Service Layer`, `Cluster 129`, `Cluster 130`, `Cron & Background Jobs`, `Parent Routes & Email`, `Concept / Rationale Nodes`, `Document Vault Flow`, `Mobile Tabs Misc`, `Audit & Organizer Middleware`, `Competitions Routes & Recs`, `Themed Components & Hooks`, `Mobile API Plumbing`, `Push Notifications`, `Mobile Registrations Service`, `Cluster 67`, `Cluster 70`, `Cluster 94`, `Cluster 97`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `Brand` connect `Auth & Twilio OTP` to `Cluster 96`, `Cluster 66`, `Mobile Admin Service`, `Database Columns & Keys`, `Cluster 100`, `Cluster 99`, `Cluster 106`, `Mobile Theme System`, `Admin API Methods`, `Profile Completion`, `Concept / Rationale Nodes`, `Reset Project Script`, `Cluster 55`, `Cluster 91`, `Cluster 127`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **What connects `CATEGORY_LABEL`, `styles`, `STATUS_PILL` to the rest of the system?**
