...
## Corpus Check
- 351 files · ~3,421,971 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2860 nodes · 6023 edges · 204 communities (130 shown, 74 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 100 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3e9ef236`
...
3. `apiRequest()` - 70 edges
4. `Card()` - 69 edges
5. `Button()` - 67 edges
6. `PageHeader()` - 52 edges
7. `getCompetitionConfig()` - 49 edges
8. `Sprint Plan (Full Roadmap)` - 48 edges
9. `Brand` - 47 edges
...
Cohesion: 0.04
Nodes (59): Registration, apiRequest(), RequestOptions, AuthResponse, getMe(), sendOtp(), sendPhoneOtp(), create() (+51 more)

### Community 1 - "School Auth Context"
Cohesion: 0.04
Nodes (42): AnnouncementCard(), fmtDate(), styles, ExamPlayerScreen(), fmtClock(), ExamResultScreen(), styles, sum() (+34 more)

### Community 2 - "Mobile API Service Layer"
Cohesion: 0.07
Nodes (52): DEFAULTS, marketingHttp, questionBankHttp, questionMakerHttp, { Provider, useHook }, CATEGORIES, CompetitionFormProps, DEFAULTS (+44 more)

### Community 3 - "Web Admin Layout"
Cohesion: 0.06
Nodes (41): FILTERS, schoolHttp, { Provider, useHook }, SchoolContext, SchoolCtx, schoolFetch(), schoolHttp, useSchool() (+33 more)

### Community 4 - "Database Columns & Keys"
Cohesion: 0.04
Nodes (43): pool, ACCOUNTS, main(), normalizePhone(), SOFT_DELETE_TABLES, authMiddleware(), Request, fileContent (+35 more)

### Community 5 - "Backend DB Bootstrap"
Cohesion: 0.05
Nodes (56): Db, upsertSchoolFromNpsn(), authLimiter, bulkUploadLimiter, otpSendLimiter, otpVerifyLimiter, passwordResetLimiter, pinVerifyLimiter (+48 more)

### Community 6 - "Admin / Audit Middleware"
Cohesion: 0.06
Nodes (32): adminHttp, certificatesHttp, commerceHttp, Certificate, ListResponse, DEFAULTS, Product, ProductsPage() (+24 more)

### Community 7 - "Web Auth Contexts"
Cohesion: 0.04
Nodes (32): CATEGORY_EMOJIS, CompetitionDetailPage(), formatDate(), formatPrice(), STATUS_PILL, STATUS_PILL_CFG, styles, CategoryAccent (+24 more)
...
Cohesion: 0.07
Nodes (33): QuestionBankDashboard(), QuestionRow, fmt(), fmtRp(), Revenue(), RevenueData, RevenuePage(), ADMIN_QUICK (+25 more)

### Community 10 - "Web API Client"
Cohesion: 0.09
Nodes (30): CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS, fmtForInput(), FORM_DEFAULTS, Order (+22 more)

### Community 11 - "Auth & Twilio OTP"
Cohesion: 0.04
Nodes (49): code:block6 (T5 (reg_number) ──────────► T16 (mobile shows it)), Dependency Map, SPRINT 0 — Quick Wins ✅ COMPLETE, SPRINT 10 — Mobile Bug Fixes (May 6, 2026 Session 2) ✅ COMPLETE, SPRINT 11 — Bug Fixes (May 6, 2026 Session 3) ✅ COMPLETE, SPRINT 12 — Rebrand Kompetix → Competzy (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 13 — Production Infra Templates (May 9, 2026 Session 5) ✅ LOCAL ARTIFACTS DONE, SPRINT 14 — Compliance & Security Hardening (May 8–9, 2026 Sessions 4–5) ✅ COMPLETE (+41 more)
...
Cohesion: 0.05
Nodes (37): audit(), AuditOptions, REDACT_KEYS, organizerOnly(), compId, compIdFilter, conditions, csv (+29 more)

### Community 15 - "Parent Routes & Email"
Cohesion: 0.07
Nodes (24): BulkJob, styles, Registration, School, Student, styles, HapticTab(), NotificationTabIcon() (+16 more)

### Community 16 - "Web UI Components"
Cohesion: 0.06
Nodes (33): compFilter(), liveFilter(), softDelete(), requireRole(), loadFlow(), compId, hasCompAccess(), id (+25 more)
...
Cohesion: 0.09
Nodes (38): announcement(), area(), exam(), localToday(), main(), material(), product(), question() (+30 more)

### Community 20 - "Admin Routes (Backend)"
Cohesion: 0.09
Nodes (23): BatchResult, BulkPaymentPage(), fmtRp(), RegistrationRow, CatalogCompetition, CompetitionCard(), fmtDate(), ExamResultPage() (+15 more)
...
Cohesion: 0.07
Nodes (29): env, actorRole, coveredOrderId, expectedSig, linkedIds, orderId, redirectToken, RegContext (+21 more)

### Community 24 - "Payments Backend"
Cohesion: 0.06
Nodes (27): adminOnly(), CHECK_TYPES, CheckType, compId, FlowStep, router, sets, steps (+19 more)

### Community 25 - "Document Vault Flow"
Cohesion: 0.16
Nodes (20): CompetitionAdminLayout(), CompetitionAnnouncementsLayout(), { Provider, useHook }, CompetitionCertificatesLayout(), CompetitionCertificatesPage(), MyCertificate, competitionPaths(), competitionRegistry (+12 more)
...
Cohesion: 0.08
Nodes (16): navTheme, queryClient, RootLayout(), Surface, AuthContextType, AuthProvider(), RegistrationStatus, MenuItem (+8 more)
...
Cohesion: 0.17
Nodes (28): analytics, AuthContext (useUser), ChildrenScreen, CompetitionDetailArchive, CompetitionDetailPage, DiscoverScreen, competitions.service, favorites.service (+20 more)
...
Cohesion: 0.13
Nodes (14): AuthContext, AuthCtx, { Provider, useHook }, useAuth(), createRoleAuth(), Http, RoleAuthConfig, RoleAuthCtx (+6 more)
...
Cohesion: 0.11
Nodes (18): adminOrSchoolAdmin(), schoolAdminOnly(), teacherOrSchoolAdmin(), teacherOrAdminOnly(), next, allRows, conditions, countParams (+10 more)
...
Cohesion: 0.14
Nodes (15): Radius, subjectColorFor(), GeometricHeader, GeometricHeaderImpl(), Palette, paletteColors(), Props, Pill (+7 more)
...
Cohesion: 0.12
Nodes (11): childrenMap, expiresAt, normalizedEmail, params, pin, router, smtpReady, studentColumns (+3 more)
...
Cohesion: 0.12
Nodes (9): AccessInfo, AffiliatedCredential, AvailableExam, CheckType, CompetitionDashboardPage(), FlowProgress, FlowProgressStep, MyCertificate (+1 more)

### Community 68 - "Cluster 68"
Cohesion: 0.16
Nodes (16): AppAutocomplete, AppInput, auth.signup, historical.service, ProfileCompletionScreen, ProfileEditScreen, HistoryScreen, Schools Service (Mobile) (+8 more)

### Community 69 - "Cluster 69"
Cohesion: 0.14
Nodes (14): AnnouncementsPage(), CertificatesPage(), ExamsListPage(), GradingQueuePage(), ExamEditorPage(), ExamQuestion, GRADE_OPTIONS, LoadedExam (+6 more)
...
## Knowledge Gaps
- **1170 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+1165 more)
...
- **Why does `Button()` connect `Admin Routes (Backend)` to `School Auth Context`, `Mobile API Service Layer`, `Web Admin Layout`, `Cluster 99`, `Cluster 69`, `Admin / Audit Middleware`, `Competitions Routes & Recs`, `Cluster 67`, `Cron & Background Jobs`, `Web API Client`, `Admin API Methods`, `Cluster 84`, `Cluster 85`, `Cluster 86`, `Profile Edit & Interests`, `Document Vault Flow`, `School Admin Routes`, `Auth Login & Profile Setup`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `Card()` connect `Admin Routes (Backend)` to `Mobile API Service Layer`, `Web Admin Layout`, `Cluster 99`, `Cluster 69`, `Admin / Audit Middleware`, `Cluster 67`, `Cron & Background Jobs`, `Web API Client`, `Mobile Payments Service`, `Cluster 85`, `Cluster 84`, `Cluster 55`, `Cluster 86`, `Document Vault Flow`, `School Admin Routes`, `Auth Login & Profile Setup`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `cn()` connect `School Admin Routes` to `Mobile API Service Layer`, `Web Admin Layout`, `Cluster 66`, `Cluster 69`, `Admin / Audit Middleware`, `Competitions Routes & Recs`, `Cron & Background Jobs`, `Web API Client`, `Admin API Methods`, `Cluster 83`, `Admin Routes (Backend)`, `Cluster 84`, `Cluster 86`, `Profile Edit & Interests`, `Cluster 55`, `Cluster 61`?**
