...
## Corpus Check
- 368 files · ~3,430,955 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2986 nodes · 6309 edges · 203 communities (129 shown, 74 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 101 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0ff3abdc`
...
9. `Badge()` - 49 edges
10. `getCompetitionConfig()` - 49 edges
...
Cohesion: 0.03
Nodes (71): Registration, apiRequest(), RequestOptions, resolveFileUrl(), Certificate, getMine(), createOrder(), CreateOrderBody (+63 more)

### Community 1 - "School Auth Context"
Cohesion: 0.04
Nodes (49): navTheme, queryClient, RootLayout(), AnnouncementCard(), fmtDate(), styles, CertificateCard(), fmtDate() (+41 more)

### Community 2 - "Mobile API Service Layer"
Cohesion: 0.06
Nodes (52): DEFAULTS, marketingHttp, questionBankHttp, { Provider, useHook }, CHECK_TYPE_LABEL, CHECK_TYPE_OPTIONS, CheckType, FlowStep (+44 more)

### Community 3 - "Web Admin Layout"
Cohesion: 0.08
Nodes (36): FILTERS, adminHttp, schoolHttp, ExamRow, QueueRow, Competition, STATUS_BADGE, STATUS_STYLE (+28 more)

### Community 4 - "Database Columns & Keys"
Cohesion: 0.06
Nodes (45): CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS, STATUSES, GradeMultiSelect(), GradeMultiSelectProps, GRADES (+37 more)
...
Cohesion: 0.08
Nodes (33): CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS, fmtForInput(), FORM_DEFAULTS, FlowEditorDialog() (+25 more)

### Community 9 - "Cron & Background Jobs"
Cohesion: 0.05
Nodes (37): schoolHttp, { Provider, useHook }, SchoolContext, SchoolCtx, schoolFetch(), useSchool(), BatchResult, BulkPaymentPage() (+29 more)
...
Cohesion: 0.06
Nodes (39): ReviewQuestionPage(), cn(), StatusBadge(), SchoolPendingPage(), ExamPlayerPage(), fmt(), Avatar(), AvatarBadge() (+31 more)
...
Cohesion: 0.05
Nodes (40): adminOnly(), adminOrSchoolAdmin(), schoolAdminOnly(), teacherOrSchoolAdmin(), compId, compIdFilter, conditions, csv (+32 more)
...
Cohesion: 0.09
Nodes (29): AnnouncementsPage(), Certificate, CertificatesPage(), ListResponse, ExamsListPage(), GradingQueuePage(), QuestionEditorPage(), MaterialsPage() (+21 more)
...
Cohesion: 0.15
Nodes (21): CompetitionAdminLayout(), CompetitionAnnouncementsLayout(), { Provider, useHook }, CompetitionCertificatesLayout(), competitionPaths(), competitionRegistry, defaultPortalConfig(), getCompetitionConfig() (+13 more)
...
Cohesion: 0.07
Nodes (26): ExamResultScreen(), styles, sum(), Radius, Shadow, subjectColorFor(), ExamSection, HEIGHT (+18 more)
...
Cohesion: 0.09
Nodes (25): ALL_GRADES, CompSpec, main(), mc(), reset(), RESET_TABLES, SECONDARY_GRADES, seedCompetition() (+17 more)

### Community 37 - "Competitions CSV Seeder"
Cohesion: 0.09
Nodes (22): metadata, defaultCompetition, destinationFor(), goTo(), Mode, ROLES, RoleSelector(), TAGLINES (+14 more)
...
Cohesion: 0.09
Nodes (11): AppUser, GradeLevel, MOCK_USER, UserRole, AuthContextType, AuthProvider(), RegistrationStatus, IoniconName (+3 more)
...
Cohesion: 0.12
Nodes (19): errorHandler(), HttpError, Province, provinces, regencies, Regency, router, initializeCronJobs() (+11 more)
...
Cohesion: 0.12
Nodes (11): styles, CheckoutState, IoniconName, ORDER_PAID, STATE_CONTENT, styles, styles, CartItem (+3 more)
...
Cohesion: 0.33
Nodes (6): commerceHttp, CREATE_DEFAULTS, rupiah(), Voucher, VoucherGroup, VouchersPage()
...
## Knowledge Gaps
- **1224 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+1219 more)
...
- **Why does `Button()` connect `Database Columns & Keys` to `Web Auth API`, `Mobile API Service Layer`, `Web Admin Layout`, `Cluster 99`, `Competitions CSV Seeder`, `Cluster 103`, `Auth & Competitions Routes`, `Cron & Background Jobs`, `Profile Completion`, `Cluster 81`, `Cluster 82`, `Web UI Components`, `Analytics & Competition Detail`, `Legacy Vite/Express Stack`, `Teacher Mobile Flow`, `Payments Backend`, `Cluster 57`, `Cluster 94`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `Card()` connect `Teacher Mobile Flow` to `School Auth Context`, `Mobile API Service Layer`, `Web Admin Layout`, `Database Columns & Keys`, `Cluster 99`, `Cluster 103`, `Auth & Competitions Routes`, `Cron & Background Jobs`, `Mobile API Plumbing`, `Profile Completion`, `Cluster 81`, `Cluster 82`, `Web UI Components`, `Analytics & Competition Detail`, `Payments Backend`, `Cluster 89`, `Cluster 94`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `cn()` connect `Web UI Components` to `Mobile API Service Layer`, `Web Admin Layout`, `Database Columns & Keys`, `Competitions CSV Seeder`, `Cluster 70`, `Auth & Competitions Routes`, `Cron & Background Jobs`, `Mobile API Plumbing`, `Cluster 80`, `Cluster 81`, `Legacy Vite/Express Stack`, `Teacher Mobile Flow`, `Cluster 61`?**
