...
## Corpus Check
- 345 files · ~3,416,511 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2819 nodes · 5901 edges · 207 communities (134 shown, 73 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 96 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f69f831f`
...
Cohesion: 0.08
Nodes (60): DEFAULTS, commerceHttp, marketingHttp, competitionsApi, CATEGORIES, CATS, CompetitionsPage(), Field() (+52 more)

### Community 1 - "School Auth Context"
Cohesion: 0.04
Nodes (55): Registration, apiRequest(), RequestOptions, create(), Document, list(), remove(), ExamResult (+47 more)

### Community 2 - "Mobile API Service Layer"
Cohesion: 0.06
Nodes (53): CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS, STATUSES, Answer, COGNITIVE, Entry (+45 more)

### Community 3 - "Web Admin Layout"
Cohesion: 0.05
Nodes (40): pool, env, ACCOUNTS, main(), normalizePhone(), authMiddleware(), Request, errorHandler() (+32 more)

### Community 4 - "Database Columns & Keys"
Cohesion: 0.05
Nodes (35): AnnouncementCard(), fmtDate(), styles, ExamPlayerScreen(), fmtClock(), ExamResultScreen(), styles, sum() (+27 more)

### Community 5 - "Backend DB Bootstrap"
Cohesion: 0.04
Nodes (57): base, byId, codes, compId, discounted, id, imageUpload, { limit, offset, page } (+49 more)
...
Cohesion: 0.09
Nodes (37): AnnouncementsPage(), questionBankHttp, { Provider, useHook }, ExamRow, ExamsListPage(), GradingQueuePage(), QueueRow, ExamEditorPage() (+29 more)

### Community 8 - "Auth & Competitions Routes"
Cohesion: 0.06
Nodes (32): CatalogCompetition, CompetitionCard(), fmtDate(), Competition, CompetitionDetailPage(), ExamQuestion, fmtDate(), fmtRp() (+24 more)
...
Cohesion: 0.05
Nodes (34): schoolHttp, { Provider, useHook }, SchoolContext, SchoolCtx, schoolFetch(), schoolHttp, useSchool(), BatchResult (+26 more)
...
Cohesion: 0.06
Nodes (24): Radius, Shadow, formatDate(), MyRegistrationDetailsScreen(), styles, IoniconName, styles, TYPE_EMOJI (+16 more)
...
Cohesion: 0.07
Nodes (28): productCompIfAccessible(), voucherGroupCompIfAccessible(), ansByQ, byNumber, chosen, CLEARED_REG, compId, correctPt (+20 more)
...
Cohesion: 0.11
Nodes (16): FILTERS, Competition, Registration, RegistrationsPage(), STATUS_CLS, STATUS_STYLE, STATUS_TABS, Tabs() (+8 more)
...
Cohesion: 0.09
Nodes (12): styles, AuthTab, styles, AppInput(), AppInputProps, styles, styles, UserProfile (+4 more)

### Community 36 - "Mobile Tabs Misc"
Cohesion: 0.11
Nodes (23): Sidebar(), SidebarContext, SidebarContextProps, SidebarFooter(), SidebarGroupAction(), SidebarInput(), SidebarMenuAction(), SidebarMenuBadge() (+15 more)
...
Cohesion: 0.11
Nodes (12): INTEREST_CATEGORIES, InterestCategory, Surface, DOC_TYPES, Document, IoniconName, styles, formatDateForDisplay() (+4 more)

### Community 42 - "Mobile API Plumbing"
Cohesion: 0.1
Nodes (15): navTheme, queryClient, AuthContextType, RegistrationStatus, styles, acceptInvitation(), approveLink(), DebugInvitation (+7 more)
...
Cohesion: 0.13
Nodes (12): TYPES, STATUS_CLS, STATUS_STYLE, StatusBadge(), STATUSES, PageHeader(), Pager(), Spinner() (+4 more)
...
Cohesion: 0.12
Nodes (15): Activity, Competition, fmtRp(), OrganizerDashboardPage(), RecentActivity, Stats, fmt(), fmtRp() (+7 more)
...
Cohesion: 0.14
Nodes (13): useIsMobile(), AppShellProps, AppShellUser, NavItem, Separator(), SidebarContent(), SidebarGroup(), SidebarGroupContent() (+5 more)

### Community 58 - "Cluster 58"
Cohesion: 0.15
Nodes (12): metadata, RootLayout(), AuthContext, AuthCtx, AuthProvider(), { Provider, useHook }, useAuth(), NAV (+4 more)

### Community 59 - "Cluster 59"
Cohesion: 0.12
Nodes (15): schoolAdminOnly(), teacherOrSchoolAdmin(), allRows, conditions, countParams, csv, csvRows, doc (+7 more)
...
Cohesion: 0.14
Nodes (6): authApi, NAV, AuthContext, AuthProvider(), Ctx, LINKS
...
Cohesion: 0.18
Nodes (8): useAuth(), DashboardLayout(), Dashboard(), DashboardPage(), fmtRp(), Kpi, LINKS, QUICK_LINKS
...
Cohesion: 0.19
Nodes (6): NAV, QuestionBankProvider(), NAV, AppShell(), initials(), NavSection
...
Cohesion: 0.2
Nodes (7): questionMakerHttp, { Provider, useHook }, createRoleAuth(), Http, RoleAuthConfig, RoleAuthCtx, { Provider, useHook }
...
## Knowledge Gaps
- **1155 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+1150 more)
...
- **Why does `Button()` connect `Auth & Competitions Routes` to `Admin Mobile Screens`, `Express Bootstrap & Errors`, `Mobile API Service Layer`, `Cluster 99`, `Web Auth API`, `Mobile Tabs Misc`, `Web Auth Contexts`, `Cluster 73`, `Web API Client`, `Cluster 106`, `CLAUDE.md Concepts`, `Web Competitions Page`, `Cluster 84`, `Web API Index`, `Cluster 57`, `Documents Backend`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `Card()` connect `Web Auth Contexts` to `Admin Mobile Screens`, `Express Bootstrap & Errors`, `Mobile API Service Layer`, `Cluster 99`, `Web Auth API`, `Cluster 69`, `Auth & Competitions Routes`, `Cluster 73`, `Web API Client`, `Cluster 106`, `CLAUDE.md Concepts`, `Push Notifications`, `Cluster 84`, `Web API Index`, `Documents Backend`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `cn()` connect `Mobile API Service Layer` to `Admin Mobile Screens`, `Express Bootstrap & Errors`, `Mobile Tabs Misc`, `Web Auth Contexts`, `Auth & Competitions Routes`, `Web API Client`, `Cluster 74`, `CLAUDE.md Concepts`, `Push Notifications`, `Web Competitions Page`, `Cluster 83`, `Cluster 57`, `Cluster 61`, `Cluster 94`?**
