...
## Corpus Check
- 348 files · ~3,420,339 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2849 nodes · 5993 edges · 208 communities (135 shown, 73 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 100 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `79c31a03`
...
8. `Brand` - 47 edges
9. `Badge()` - 45 edges
10. `getCompetitionConfig()` - 45 edges
...
## Communities (208 total, 73 thin omitted)

### Community 0 - "Admin Mobile Screens"
Cohesion: 0.04
Nodes (59): BulkJob, styles, styles, AuthTab, styles, AppInput(), AppInputProps, styles (+51 more)

### Community 1 - "School Auth Context"
Cohesion: 0.04
Nodes (55): Registration, apiRequest(), RequestOptions, AuthResponse, getMe(), sendOtp(), sendPhoneOtp(), create() (+47 more)
...
Cohesion: 0.08
Nodes (45): AnnouncementsPage(), adminHttp, marketingHttp, questionBankHttp, { Provider, useHook }, GradingQueuePage(), QueueRow, ExamEditorPage() (+37 more)
...
Cohesion: 0.05
Nodes (33): pool, env, ACCOUNTS, main(), normalizePhone(), authMiddleware(), Request, fileContent (+25 more)

### Community 6 - "Admin / Audit Middleware"
Cohesion: 0.08
Nodes (29): schoolHttp, Competition, CsvRow, JobStatus, STEPS, ExamRow, ExamsListPage(), Competition (+21 more)
...
Cohesion: 0.07
Nodes (36): BatchResult, RegistrationRow, CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS, STATUSES, Answer (+28 more)
...
Cohesion: 0.05
Nodes (36): adminOnly(), adminOrSchoolAdmin(), organizerOnly(), compId, compIdFilter, conditions, csv, csvRows (+28 more)
...
Cohesion: 0.12
Nodes (28): defaultCompetition, destinationFor(), goTo(), Mode, ROLES, RoleSelector(), UnifiedLogin(), ArrowRightIcon() (+20 more)
...
Cohesion: 0.15
Nodes (21): CompetitionAdminLayout(), CompetitionAnnouncementsLayout(), { Provider, useHook }, BrandPanel(), Props, CompetitionPortalConfig, competitionPaths(), CompetitionPortalConfig (+13 more)
...
Cohesion: 0.07
Nodes (20): navTheme, queryClient, AnnouncementCard(), fmtDate(), styles, ExamPlayerScreen(), fmtClock(), styles (+12 more)

### Community 26 - "Documents Backend"
Cohesion: 0.12
Nodes (19): CompetitionAdminPage(), EmcAdminPage(), FILTERS, PendingRow, StatusFilter, Announcement, AnnouncementCard(), CompetitionAnnouncementsPage() (+11 more)
...
Cohesion: 0.09
Nodes (16): Registration, School, Student, styles, Round, styles, styles, styles (+8 more)
...
Cohesion: 0.09
Nodes (10): HapticTab(), NotificationTabIcon(), NotificationTabIconProps, styles, AuthContextType, RegistrationStatus, IoniconName, styles (+2 more)

### Community 38 - "Audit & Organizer Middleware"
Cohesion: 0.12
Nodes (22): Sidebar(), SidebarContext, SidebarContextProps, SidebarGroupAction(), SidebarGroupContent(), SidebarInput(), SidebarMenu(), SidebarMenuAction() (+14 more)
...
Cohesion: 0.13
Nodes (10): authApi, NAV, AuthContext, AuthProvider(), Ctx, useAuth(), Dashboard(), DashboardPage() (+2 more)

### Community 51 - "Reset Project Script"
Cohesion: 0.14
Nodes (20): admin.service, AdminStudentsScreen, Analytics Wrapper, auth.login, auth.logout, auth.signup, auth.verifyOtp, auth.verifyPhoneOtp (+12 more)

### Community 52 - "Mobile Payments Service"
Cohesion: 0.12
Nodes (11): certificatesHttp, questionMakerHttp, createRoleAuth(), Http, RoleAuthConfig, RoleAuthCtx, { Provider, useHook }, ExamResultPage() (+3 more)
...
Cohesion: 0.12
Nodes (19): AuthContext Registration type (external), config/api API_BASE_URL, expo-notifications (external), k6-registration.js, loadtest README, MyRegistrationDetailsScreen, payments.service, Midtrans webhook handler (+11 more)
...
Cohesion: 0.17
Nodes (15): errorHandler(), HttpError, initializeCronJobs(), scheduleBulkJobProcessor(), scheduleCertificateBackfill(), scheduleCompetitionDayReminders(), scheduleDeadlineReminders(), scheduleDeadlineUrgencyReminders() (+7 more)
...
Cohesion: 0.13
Nodes (10): AccessInfo, AffiliatedCredential, AvailableExam, CheckType, CompetitionDashboardPage(), FlowProgress, FlowProgressStep, RegistrationRow (+2 more)

### Community 64 - "Cluster 64"
Cohesion: 0.14
Nodes (9): Certificate, CertificatesPage(), ListResponse, ExamLite, PaperExam, PaperExamsPage(), Student, TestCenter (+1 more)

### Community 65 - "Cluster 65"
Cohesion: 0.13
Nodes (10): Competition, Registration, STATUS_CLS, STATUS_STYLE, STATUS_TABS, Pager(), PagerProps, ROLE_CLS (+2 more)
...
Cohesion: 0.16
Nodes (11): commerceHttp, Order, OrderItem, OrdersPage(), rupiah(), TABS, CREATE_DEFAULTS, rupiah() (+3 more)
...
Cohesion: 0.33
Nodes (5): metadata, RootLayout(), AuthProvider(), ThemeProvider(), Toaster()
...
## Knowledge Gaps
- **1166 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+1161 more)
...
- **Why does `Button()` connect `Cron & Background Jobs` to `Admin Mobile Screens`, `Mobile API Service Layer`, `Web Admin Layout`, `Admin / Audit Middleware`, `Concept / Rationale Nodes`, `Teacher Mobile Flow`, `Documents Backend`, `Express Bootstrap & Errors`, `Audit & Organizer Middleware`, `Mobile Payments Service`, `Cluster 58`, `Cluster 63`, `Cluster 64`, `Cluster 65`, `Cluster 71`, `Cluster 85`, `Cluster 86`, `Cluster 87`, `Cluster 102`, `Cluster 108`, `Cluster 109`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `Card()` connect `Web Admin Layout` to `Admin Mobile Screens`, `Mobile API Service Layer`, `Admin / Audit Middleware`, `Cron & Background Jobs`, `Web Competitions Page`, `Teacher Mobile Flow`, `Documents Backend`, `Express Bootstrap & Errors`, `Mobile Registrations Service`, `Mobile Payments Service`, `Cluster 63`, `Cluster 64`, `Cluster 65`, `Cluster 71`, `Cluster 85`, `Cluster 86`, `Cluster 87`, `Cluster 102`, `Cluster 108`, `Cluster 109`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `cn()` connect `Express Bootstrap & Errors` to `Cluster 64`, `Cluster 65`, `Mobile API Service Layer`, `Web Admin Layout`, `Cluster 66`, `Admin / Audit Middleware`, `Audit & Organizer Middleware`, `Cron & Background Jobs`, `Cluster 109`, `Concept / Rationale Nodes`, `Mobile Registrations Service`, `Web Competitions Page`, `Cluster 84`, `Cluster 85`, `Cluster 86`, `Cluster 83`, `Cluster 58`?**
