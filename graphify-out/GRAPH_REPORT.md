...
## Corpus Check
- 365 files · ~3,428,705 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2962 nodes · 6266 edges · 211 communities (137 shown, 74 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 101 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `542d4f97`
...
Cohesion: 0.04
Nodes (62): apiRequest(), RequestOptions, resolveFileUrl(), AuthResponse, getMe(), sendOtp(), sendPhoneOtp(), Certificate (+54 more)

### Community 1 - "School Auth Context"
Cohesion: 0.04
Nodes (49): styles, ExamPlayerScreen(), fmtClock(), ExamResultScreen(), styles, sum(), styles, styles (+41 more)
...
Cohesion: 0.06
Nodes (43): commerceHttp, Certificate, CertificatesPage(), ListResponse, CHECK_TYPE_LABEL, CHECK_TYPE_OPTIONS, CheckType, FlowEditorDialog() (+35 more)

### Community 4 - "Database Columns & Keys"
Cohesion: 0.07
Nodes (46): DEFAULTS, marketingHttp, questionBankHttp, { Provider, useHook }, CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS (+38 more)
...
Cohesion: 0.05
Nodes (35): CATEGORY_EMOJIS, CompetitionDetailPage(), formatDate(), formatPrice(), STATUS_PILL, STATUS_PILL_CFG, styles, CategoryAccent (+27 more)
...
Cohesion: 0.09
Nodes (31): BatchResult, RegistrationRow, ExamEditorPage(), ExamQuestion, GRADE_OPTIONS, LoadedExam, QuestionBankDashboard(), QuestionRow (+23 more)

### Community 11 - "Auth & Twilio OTP"
Cohesion: 0.05
Nodes (44): CompSpec, main(), mc(), reset(), RESET_TABLES, seedCompetition(), SeedQuestion, SPECS (+36 more)
...
Cohesion: 0.08
Nodes (27): CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS, fmtForInput(), FORM_DEFAULTS, TYPES (+19 more)

### Community 16 - "Web UI Components"
Cohesion: 0.06
Nodes (28): BulkJob, styles, Registration, School, Student, styles, Brand, styles (+20 more)
...
Cohesion: 0.12
Nodes (29): adminHttp, defaultCompetition, destinationFor(), goTo(), Mode, ROLES, RoleSelector(), UnifiedLogin() (+21 more)
...
Cohesion: 0.07
Nodes (22): navTheme, queryClient, RootLayout(), styles, CheckoutState, IoniconName, ORDER_PAID, STATE_CONTENT (+14 more)

### Community 28 - "Organizer Competition Forms"
Cohesion: 0.06
Nodes (23): AuthTab, styles, ALL_GRADES, Grade, GRADES, Role, ROLES, SD (+15 more)
...
Cohesion: 0.14
Nodes (32): analytics, AuthContext (useUser), ChildrenScreen, CompetitionDetailArchive, CompetitionDetailPage, DiscoverScreen, competitions.service, config/api (API_BASE_URL) (+24 more)
...
Cohesion: 0.17
Nodes (17): CompetitionAdminLayout(), CompetitionAnnouncementsLayout(), { Provider, useHook }, CompetitionCertificatesLayout(), competitionPaths(), defaultPortalConfig(), getCompetitionConfig(), CompetitionDashboardLayout() (+9 more)
...
Cohesion: 0.09
Nodes (28): ReviewQuestionPage(), cn(), StatusBadge(), ExamPlayerPage(), fmt(), Avatar(), AvatarBadge(), AvatarFallback() (+20 more)
...
Cohesion: 0.07
Nodes (24): Db, upsertSchoolFromNpsn(), errorHandler(), HttpError, Province, provinces, regencies, Regency (+16 more)

### Community 38 - "Audit & Organizer Middleware"
Cohesion: 0.08
Nodes (16): HapticTab(), NotificationTabIcon(), NotificationTabIconProps, styles, AuthContextType, Registration, RegistrationStatus, AffiliatedAccess (+8 more)
...
Cohesion: 0.1
Nodes (22): Sheet(), SheetContent(), SheetDescription(), SheetFooter(), SheetHeader(), SheetOverlay(), SheetTitle(), Sidebar() (+14 more)
...
Cohesion: 0.16
Nodes (10): competitionsApi, usersApi, PageHeader(), Pager(), Spinner(), Toast(), CATS, EMPTY_FORM (+2 more)
...
Cohesion: 0.12
Nodes (12): organizerAuthApi, organizerCompetitionsApi, organizerProfileApi, organizerRegistrationsApi, organizerRevenueApi, registrationsApi, CompetitionForm(), CompetitionFormValues (+4 more)
...
Cohesion: 0.13
Nodes (14): AnnouncementsPage(), ExamsListPage(), GradingQueuePage(), QuestionEditorPage(), MaterialsPage(), ProctoringPage(), ProctoringSession, CompetitionPicker() (+6 more)
...
Cohesion: 0.35
Nodes (8): notificationsApi, schoolsApi, AuthUser, Competition, Pagination, PendingRegistration, School, User

### Community 73 - "Cluster 73"
Cohesion: 0.2
Nodes (9): CatalogCompetition, CompetitionCard(), fmtDate(), fmtDateTime(), ProctoringSession, ProctoringSessionPage(), Snapshot, Badge() (+1 more)
...
## Knowledge Gaps
- **1208 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+1203 more)
...
- **Why does `Button()` connect `Web Admin Layout` to `Web Auth API`, `School Auth Context`, `Mobile API Service Layer`, `Express Bootstrap & Errors`, `Database Columns & Keys`, `Cluster 68`, `Mobile Admin Service`, `Cluster 73`, `Web API Client`, `Cluster 106`, `Themed Components & Hooks`, `Push Notifications`, `Parent Routes & Email`, `Mobile Doc & User Services`, `Cluster 85`, `Cluster 86`, `Competition Detail Mobile`, `Cluster 58`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `Card()` connect `Web API Client` to `Web Auth API`, `School Auth Context`, `Mobile API Service Layer`, `Web Admin Layout`, `Database Columns & Keys`, `Cluster 68`, `Express Bootstrap & Errors`, `Cluster 90`, `Mobile Admin Service`, `Cluster 73`, `Cluster 106`, `Auth Register Screen`, `Push Notifications`, `Parent Routes & Email`, `Legacy Vite/Express Stack`, `Cluster 85`, `Cluster 86`, `Cluster 58`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `Brand` connect `Web UI Components` to `School Auth Context`, `Cluster 100`, `Cluster 101`, `Cluster 102`, `Web Auth Contexts`, `Audit & Organizer Middleware`, `Cluster 109`, `Profile Completion`, `Mobile Registrations Service`, `Cluster 84`, `Mobile Payments Service`, `Cluster 87`, `Cluster 88`, `Parent Linking Flow`, `Organizer Competition Forms`?**
