...
## Corpus Check
- 353 files · ~3,423,169 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2874 nodes · 6053 edges · 203 communities (128 shown, 75 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 100 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bb390fa7`
...
Cohesion: 0.08
Nodes (55): DEFAULTS, commerceHttp, marketingHttp, Certificate, ListResponse, CHECK_TYPE_LABEL, CHECK_TYPE_OPTIONS, CheckType (+47 more)

### Community 1 - "School Auth Context"
Cohesion: 0.04
Nodes (55): apiRequest(), RequestOptions, AuthResponse, getMe(), sendOtp(), sendPhoneOtp(), Certificate, getMine() (+47 more)

### Community 2 - "Mobile API Service Layer"
Cohesion: 0.05
Nodes (36): AnnouncementCard(), fmtDate(), styles, CertificateCard(), fmtDate(), styles, ExamPlayerScreen(), fmtClock() (+28 more)
...
Cohesion: 0.05
Nodes (37): schoolHttp, { Provider, useHook }, SchoolContext, SchoolCtx, schoolFetch(), schoolHttp, useSchool(), BulkRegistrationPage() (+29 more)

### Community 6 - "Admin / Audit Middleware"
Cohesion: 0.07
Nodes (40): AnnouncementsPage(), CertificatesPage(), ExamRow, ExamsListPage(), GradingQueuePage(), QuestionEditorPage(), MaterialsPage(), OrdersPage() (+32 more)

### Community 7 - "Web Auth Contexts"
Cohesion: 0.07
Nodes (33): questionBankHttp, { Provider, useHook }, BatchResult, BulkPaymentPage(), fmtRp(), RegistrationRow, CatalogCompetition, CompetitionCard() (+25 more)

### Community 8 - "Auth & Competitions Routes"
Cohesion: 0.07
Nodes (38): CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS, STATUSES, Answer, COGNITIVE, Entry (+30 more)
...
Cohesion: 0.07
Nodes (24): navTheme, queryClient, RootLayout(), styles, AuthTab, styles, AppInput(), AppInputProps (+16 more)

### Community 20 - "Admin Routes (Backend)"
Cohesion: 0.09
Nodes (21): EmcAdminPage(), PendingRow, StatusFilter, Announcement, AnnouncementCard(), CompetitionAnnouncementsPage(), fmtDate(), certificatesHttp (+13 more)
...
Cohesion: 0.15
Nodes (22): CompetitionAdminLayout(), CompetitionAdminPage(), CompetitionAnnouncementsLayout(), { Provider, useHook }, CompetitionCertificatesLayout(), CompetitionCertificatesPage(), competitionPaths(), competitionRegistry (+14 more)
...
Cohesion: 0.11
Nodes (22): FILTERS, CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS, fmtForInput(), FORM_DEFAULTS (+14 more)
...
Cohesion: 0.07
Nodes (29): certCompIfAccessible(), productCompIfAccessible(), voucherGroupCompIfAccessible(), ansByQ, byNumber, chosen, CLEARED_REG, compId (+21 more)
...
Cohesion: 0.07
Nodes (17): AuthContextType, AuthProvider(), Registration, RegistrationStatus, AffiliatedAccess, create(), CreateParams, getCredentials() (+9 more)
...
Cohesion: 0.09
Nodes (18): Radius, HEIGHT, PAD_H, Props, Size, styles, Variant, EmptyState (+10 more)
...
Cohesion: 0.12
Nodes (13): notificationsApi, organizerAuthApi, organizerCompetitionsApi, organizerProfileApi, organizerRegistrationsApi, organizerRevenueApi, registrationsApi, CompetitionForm() (+5 more)

### Community 51 - "Reset Project Script"
Cohesion: 0.12
Nodes (11): AccessInfo, AffiliatedCredential, AvailableExam, CheckType, CompetitionDashboardPage(), FlowProgress, FlowProgressStep, MyCertificate (+3 more)
...
Cohesion: 0.11
Nodes (15): description, end, ics, missing, parentLinked, paymentPaid, profileComplete, profileMissing (+7 more)
...
Cohesion: 0.18
Nodes (8): metadata, AuthProvider(), ThemeToggle(), Theme, ThemeContext, ThemeContextValue, ThemeProvider(), Toaster()
...
Cohesion: 0.53
Nodes (4): BrandPanel(), Props, CompetitionPortalConfig, CompetitionPortalConfig
...
## Knowledge Gaps
- **1175 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+1170 more)
...
- **Why does `Button()` connect `Web Auth Contexts` to `Admin Mobile Screens`, `Cluster 98`, `Backend DB Bootstrap`, `Admin / Audit Middleware`, `Competitions CSV Seeder`, `Auth & Competitions Routes`, `Themed Components & Hooks`, `Reset Project Script`, `Admin Routes (Backend)`, `Cluster 84`, `Cluster 85`, `Document Vault Flow`, `Parent Linking Flow`, `Organizer Competition Forms`, `School Admin Routes`, `Cluster 57`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `Card()` connect `Web Auth Contexts` to `Admin Mobile Screens`, `Cluster 98`, `Backend DB Bootstrap`, `Admin / Audit Middleware`, `Competitions CSV Seeder`, `Auth & Competitions Routes`, `Mobile Registrations Service`, `Web Competitions Page`, `Admin Routes (Backend)`, `Reset Project Script`, `Cluster 84`, `Cluster 85`, `Document Vault Flow`, `School Admin Routes`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `cn()` connect `Competitions CSV Seeder` to `Admin Mobile Screens`, `Backend DB Bootstrap`, `Admin / Audit Middleware`, `Web Auth Contexts`, `Auth & Competitions Routes`, `Mobile Registrations Service`, `Cluster 85`, `Cluster 56`, `Cluster 57`, `Parent Linking Flow`, `Organizer Competition Forms`, `School Admin Routes`, `Cluster 63`?**
