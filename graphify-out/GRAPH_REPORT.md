...
## Corpus Check
- 359 files · ~3,425,398 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2907 nodes · 6124 edges · 219 communities (145 shown, 74 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 100 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `440b1e8a`
...
8. `Sprint Plan (Full Roadmap)` - 50 edges
...
Cohesion: 0.08
Nodes (41): commerceHttp, Certificate, ListResponse, CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS (+33 more)
...
Cohesion: 0.09
Nodes (33): adminHttp, schoolHttp, ExamRow, QueueRow, Competition, STATUS_BADGE, STATUS_STYLE, ProctoringSession (+25 more)
...
Cohesion: 0.07
Nodes (42): DEFAULTS, certificatesHttp, marketingHttp, questionBankHttp, questionMakerHttp, { Provider, useHook }, CATEGORIES, CompetitionFormProps (+34 more)

### Community 5 - "Backend DB Bootstrap"
Cohesion: 0.05
Nodes (31): CATEGORY_EMOJIS, CompetitionDetailPage(), formatDate(), formatPrice(), STATUS_PILL, STATUS_PILL_CFG, styles, CategoryAccent (+23 more)
...
Cohesion: 0.04
Nodes (49): SPRINT 0 — Quick Wins ✅ COMPLETE, SPRINT 10 — Mobile Bug Fixes (May 6, 2026 Session 2) ✅ COMPLETE, SPRINT 11 — Bug Fixes (May 6, 2026 Session 3) ✅ COMPLETE, SPRINT 12 — Rebrand Kompetix → Competzy (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 13 — Production Infra Templates (May 9, 2026 Session 5) ✅ LOCAL ARTIFACTS DONE, SPRINT 14 — Compliance & Security Hardening (May 8–9, 2026 Sessions 4–5) ✅ COMPLETE, SPRINT 15 — Launch 1 Polish (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 16 — School Portal Soft Launch (May 9, 2026 Session 5) ✅ COMPLETE (+41 more)
...
Cohesion: 0.05
Nodes (32): schoolHttp, { Provider, useHook }, SchoolContext, SchoolCtx, schoolFetch(), useSchool(), BatchResult, BulkPaymentPage() (+24 more)
...
Cohesion: 0.07
Nodes (25): FILTERS, TYPES, STATUS_CLS, STATUS_STYLE, STATUSES, Competition, Registration, STATUS_CLS (+17 more)
...
Cohesion: 0.09
Nodes (30): AnnouncementsPage(), CertificatesPage(), ExamsListPage(), GradingQueuePage(), ExamEditorPage(), ExamQuestion, GRADE_OPTIONS, LoadedExam (+22 more)

### Community 19 - "Web Competitions Page"
Cohesion: 0.06
Nodes (32): schoolAdminOnly(), teacherOrSchoolAdmin(), teacherOrAdminOnly(), next, actorRole, coveredOrderId, expectedSig, linkedIds (+24 more)
...
Cohesion: 0.08
Nodes (16): AnnouncementCard(), fmtDate(), styles, CertificateCard(), fmtDate(), styles, styles, styles (+8 more)

### Community 26 - "Documents Backend"
Cohesion: 0.08
Nodes (22): styles, AuthTab, styles, ALL_GRADES, Grade, GRADES, Role, ROLES (+14 more)
...
Cohesion: 0.08
Nodes (17): ExamResultScreen(), styles, sum(), styles, WINDOW_NOTE, styles, styles, Text (+9 more)

### Community 29 - "School Admin Routes"
Cohesion: 0.1
Nodes (21): Competition, CompetitionDetailPage(), fmtDate(), fmtRp(), formatCurrency(), STATUS_BADGE, STATUS_STYLE, ExamResultPage() (+13 more)
...
Cohesion: 0.08
Nodes (17): navTheme, queryClient, RootLayout(), AppUser, GradeLevel, MOCK_USER, UserRole, Surface (+9 more)
...
Cohesion: 0.09
Nodes (19): CatalogCompetition, CompetitionCard(), fmtDate(), fmtDate(), STATUS_STYLE, StorefrontOrder, ACTIONABLE, ACTIONABLE_STATUSES (+11 more)
...
Cohesion: 0.2
Nodes (14): CompetitionAdminLayout(), CompetitionAnnouncementsLayout(), { Provider, useHook }, CompetitionCertificatesLayout(), competitionPaths(), defaultPortalConfig(), getCompetitionConfig(), CompetitionDashboardLayout() (+6 more)
...
Cohesion: 0.12
Nodes (22): errorHandler(), HttpError, backfillCertificates(), BestAttempt, CLEARED, DB, issueCertificateIfEligible(), IssueResult (+14 more)
...
Cohesion: 0.12
Nodes (22): Sidebar(), SidebarContext, SidebarContextProps, SidebarFooter(), SidebarGroupAction(), SidebarInput(), SidebarMenu(), SidebarMenuAction() (+14 more)
...
Cohesion: 0.12
Nodes (13): Radius, subjectColorFor(), styles, Tab, GeometricHeader, GeometricHeaderImpl(), Palette, paletteColors() (+5 more)
...
Cohesion: 0.13
Nodes (14): useIsMobile(), AppShellProps, AppShellUser, NavItem, Separator(), SidebarContent(), SidebarGroup(), SidebarGroupContent() (+6 more)

### Community 62 - "Cluster 62"
Cohesion: 0.18
Nodes (7): { Provider, useHook }, BrandPanel(), Props, CompetitionPortalConfig, EMC, CompetitionPortalConfig, competitionRegistry
...
Cohesion: 0.12
Nodes (11): Shadow, HEIGHT, PAD_H, Props, Size, styles, Variant, Props (+3 more)
...
Cohesion: 0.15
Nodes (8): OrganizerProvider(), NAV, OrganizerLayoutInner(), QuestionBankProvider(), NAV, AppShell(), initials(), NavSection
...
Cohesion: 0.16
Nodes (12): organizerHttp, createRoleAuth(), Http, RoleAuthConfig, RoleAuthCtx, OrganizerContext, OrganizerCtx, { Provider, useHook } (+4 more)
...
Cohesion: 0.21
Nodes (5): styles, styles, CartItem, useCart(), rupiah()
...
Cohesion: 0.5
Nodes (3): ExamPlayerScreen(), fmtClock(), styles
...
## Knowledge Gaps
- **1187 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+1182 more)
...
- **Why does `Button()` connect `School Admin Routes` to `Admin Mobile Screens`, `Cluster 65`, `Mobile API Service Layer`, `Mobile Admin Service`, `Database Columns & Keys`, `Mobile Tabs Misc`, `Cluster 72`, `Mobile API Plumbing`, `Auth & Twilio OTP`, `Auth Register Screen`, `Mobile App Bootstrap`, `Cluster 112`, `Mobile Doc & User Services`, `Cluster 61`, `Cluster 94`, `Auth Login & Profile Setup`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `Card()` connect `Mobile Doc & User Services` to `Admin Mobile Screens`, `Cluster 65`, `Mobile API Service Layer`, `Mobile Admin Service`, `Database Columns & Keys`, `Mobile Tabs Misc`, `Cluster 72`, `Auth & Twilio OTP`, `Mobile App Bootstrap`, `Cluster 112`, `Cluster 56`, `School Admin Routes`, `Cluster 94`, `Auth Login & Profile Setup`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `cn()` connect `Mobile Admin Service` to `Admin Mobile Screens`, `Mobile API Service Layer`, `Cluster 67`, `Database Columns & Keys`, `Mobile Tabs Misc`, `Cluster 68`, `Mobile API Plumbing`, `Auth & Twilio OTP`, `Auth Register Screen`, `Mobile App Bootstrap`, `Mobile Doc & User Services`, `Cluster 61`, `Cluster 56`, `Cluster 92`, `School Admin Routes`?**
