...
## Corpus Check
- 361 files · ~3,427,103 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2950 nodes · 6208 edges · 220 communities (146 shown, 74 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 101 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ab55fe8f`
...
## Communities (220 total, 74 thin omitted)
...
Cohesion: 0.05
Nodes (31): AnnouncementCard(), fmtDate(), styles, CertificateCard(), fmtDate(), styles, ExamPlayerScreen(), fmtClock() (+23 more)

### Community 3 - "Web Admin Layout"
Cohesion: 0.09
Nodes (28): FILTERS, schoolHttp, Competition, CsvRow, JobStatus, STEPS, ExamRow, QueueRow (+20 more)

### Community 4 - "Database Columns & Keys"
Cohesion: 0.07
Nodes (36): adminHttp, commerceHttp, marketingHttp, Certificate, CertificatesPage(), ListResponse, CHECK_TYPE_LABEL, CHECK_TYPE_OPTIONS (+28 more)

### Community 5 - "Backend DB Bootstrap"
Cohesion: 0.09
Nodes (40): DEFAULTS, questionBankHttp, { Provider, useHook }, CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS, STATUSES (+32 more)
...
Cohesion: 0.08
Nodes (34): AnnouncementsPage(), BatchResult, RegistrationRow, ExamsListPage(), GradingQueuePage(), QuestionEditorPage(), MaterialsPage(), ProctoringPage() (+26 more)
...
Cohesion: 0.09
Nodes (23): ExamEditorPage(), ExamQuestion, GRADE_OPTIONS, LoadedExam, TYPES, STATUS_CLS, STATUS_STYLE, STATUSES (+15 more)
...
Cohesion: 0.09
Nodes (27): CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS, fmtForInput(), FORM_DEFAULTS, FlowEditorDialog() (+19 more)
...
Cohesion: 0.06
Nodes (29): schoolAdminOnly(), actorRole, coveredOrderId, expectedSig, linkedIds, orderId, redirectToken, RegContext (+21 more)
...
Cohesion: 0.08
Nodes (20): Radius, Shadow, Slide, slides, styles, HEIGHT, PAD_H, Props (+12 more)
...
Cohesion: 0.09
Nodes (19): useIsMobile(), QuestionBankProvider(), NAV, AppShell(), AppShellProps, AppShellUser, initials(), NavItem (+11 more)
...
Cohesion: 0.08
Nodes (26): adminOnly(), adminOrSchoolAdmin(), teacherOrSchoolAdmin(), compId, compIdFilter, conditions, csv, csvRows (+18 more)

### Community 40 - "Beyond Classroom PDF"
Cohesion: 0.09
Nodes (21): byExam, choiceQids, CLEARED, compId, deadline, examId, id, optionsByQ (+13 more)
...
Cohesion: 0.13
Nodes (12): navTheme, queryClient, RootLayout(), styles, AuthTab, styles, AppInput(), AppInputProps (+4 more)
...
Cohesion: 0.16
Nodes (13): Elevation, Fonts, Motion, subjectColorFor(), SubjectColors, Pill, PillImpl(), Props (+5 more)
...
Cohesion: 0.14
Nodes (10): RequestOptions, resolveFileUrl(), Announcement, getAnnouncements(), getMaterials(), Material, sendSuggestion(), School (+2 more)
...
Cohesion: 0.22
Nodes (4): Area, AREA_DEFAULTS, TC_DEFAULTS, TestCenter
...
- **Why does `Button()` connect `Registrations Routes` to `Web Admin Layout`, `Database Columns & Keys`, `Backend DB Bootstrap`, `Web Auth Contexts`, `Mobile Doc & User Services`, `Web Competitions Page`, `Document Vault Flow`, `Documents Backend`, `Auth Login & Profile Setup`, `Web Auth API`, `Mobile Admin Service`, `Mobile Tabs Misc`, `Cluster 75`, `Cluster 90`, `Cluster 92`, `Cluster 93`, `Cluster 97`, `Cluster 113`, `Cluster 117`, `Cluster 118`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `Card()` connect `Web Auth Contexts` to `Web Admin Layout`, `Database Columns & Keys`, `Backend DB Bootstrap`, `Registrations Routes`, `Mobile Doc & User Services`, `Admin Routes (Backend)`, `Document Vault Flow`, `Auth Login & Profile Setup`, `Web Auth API`, `Mobile Tabs Misc`, `Mobile API Plumbing`, `Cluster 75`, `Cluster 90`, `Cluster 92`, `Cluster 93`, `Cluster 97`, `Cluster 98`, `Cluster 113`, `Cluster 117`, `Cluster 118`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `Brand` connect `Auth & Competitions Routes` to `Web Auth API`, `Cluster 65`, `Mobile API Service Layer`, `Cluster 67`, `Cluster 100`, `Cluster 101`, `Auth Register Screen`, `Mobile Theme System`, `Profile Completion`, `Mobile Registrations Service`, `Profile Edit & Interests`, `Competition Detail Mobile`, `Cluster 55`, `Cluster 95`?**
