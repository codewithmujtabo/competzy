...
## Corpus Check
- 371 files · ~3,448,888 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2994 nodes · 6310 edges · 210 communities (133 shown, 77 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 94 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9fbf081f`
...
Cohesion: 0.04
Nodes (49): styles, AuthTab, styles, AppInput(), AppInputProps, styles, ExamResultScreen(), styles (+41 more)

### Community 2 - "Mobile API Service Layer"
Cohesion: 0.07
Nodes (50): AnnouncementsPage(), DEFAULTS, commerceHttp, marketingHttp, Certificate, CertificatesPage(), ListResponse, ExamsListPage() (+42 more)

### Community 3 - "Web Admin Layout"
Cohesion: 0.06
Nodes (48): questionBankHttp, { Provider, useHook }, BatchResult, RegistrationRow, ExamEditorPage(), ExamQuestion, GRADE_OPTIONS, LoadedExam (+40 more)

### Community 4 - "Database Columns & Keys"
Cohesion: 0.06
Nodes (51): CATEGORIES, CompetitionFormProps, DEFAULTS, STATUSES, CHECK_TYPE_LABEL, CHECK_TYPE_OPTIONS, CheckType, FlowEditorDialog() (+43 more)
...
Cohesion: 0.08
Nodes (29): schoolHttp, Competition, CsvRow, JobStatus, STEPS, ExamRow, QueueRow, Competition (+21 more)
...
Cohesion: 0.05
Nodes (40): authMiddleware(), Request, errorHandler(), HttpError, organizerOnly(), cached, competitions, conditions (+32 more)
...
Cohesion: 0.07
Nodes (30): CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS, fmtForInput(), FORM_DEFAULTS, STATUS_CLS (+22 more)
...
Cohesion: 0.11
Nodes (31): adminHttp, defaultCompetition, destinationFor(), goTo(), Mode, ROLES, RoleSelector(), TAGLINES (+23 more)
...
Cohesion: 0.09
Nodes (40): announcement(), area(), demoCertificate(), exam(), localToday(), main(), material(), product() (+32 more)
...
Cohesion: 0.07
Nodes (28): ansByQ, byNumber, chosen, CLEARED_REG, compId, correctPt, examCompIfAccessible(), examId (+20 more)

### Community 29 - "School Admin Routes"
Cohesion: 0.08
Nodes (28): announcementRecipients(), announcementScopeIfAccessible(), assetUpload, bonus, code, compId, content, custom (+20 more)
...
Cohesion: 0.12
Nodes (22): CompetitionAdminLayout(), Announcement, AnnouncementCard(), CompetitionAnnouncementsPage(), fmtDate(), CompetitionCertificatesPage(), MyCertificate, competitionPaths() (+14 more)

### Community 32 - "Web Auth API"
Cohesion: 0.07
Nodes (21): navTheme, queryClient, AuthContextType, AuthProvider(), Registration, RegistrationStatus, IoniconName, PAYER_OPTIONS (+13 more)

### Community 33 - "Express Bootstrap & Errors"
Cohesion: 0.08
Nodes (26): certCompIfAccessible(), compId, id, label, { limit, offset, page }, mapCertificate(), pageParams(), params (+18 more)
...
Cohesion: 0.07
Nodes (26): base, byId, codes, compId, discounted, id, imageUpload, { limit, offset, page } (+18 more)
...
Cohesion: 0.08
Nodes (17): styles, WINDOW_NOTE, styles, subjectColorFor(), Surface, AvailableExam, Material, CompetitionMark (+9 more)
...
Cohesion: 0.18
Nodes (16): CompetitionAdminPage(), EmcAdminPage(), FILTERS, PendingRow, StatusFilter, emcHttp, PortalCompetition, usePortalComp() (+8 more)
...
Cohesion: 0.16
Nodes (10): competitionsApi, schoolsApi, PageHeader(), Pager(), Spinner(), Toast(), CATS, EMPTY_FORM (+2 more)
...
Cohesion: 0.11
Nodes (15): organizerHttp, notificationsApi, organizerAuthApi, organizerCompetitionsApi, organizerProfileApi, organizerRegistrationsApi, organizerRevenueApi, registrationsApi (+7 more)
...
Cohesion: 0.12
Nodes (4): pool, ACCOUNTS, main(), normalizePhone()
...
Cohesion: 0.2
Nodes (8): BrandPanel(), TAGLINES, WORD_SLOTS, Props, CompetitionPortalConfig, EMC, CompetitionPortalConfig, competitionRegistry
...
Cohesion: 0.32
Nodes (9): http, req(), token(), AuthUser, Competition, Pagination, PendingRegistration, School (+1 more)
...
Cohesion: 0.2
Nodes (10): midtrans.service.ts, payments.routes.ts, POST /school-batch, POST /api/payments/snap, GET /verify/:registrationId, Midtrans webhook handler, Rationale: school-named Midtrans receipt, Rationale: verify endpoint (+2 more)
...
- **Why does `Button()` connect `Web Admin Layout` to `School Auth Context`, `Mobile API Service Layer`, `Database Columns & Keys`, `Web Auth Contexts`, `Themed Components & Hooks`, `Auth & Twilio OTP`, `Auth Register Screen`, `Historical Phone Login`, `Cluster 75`, `Parent Routes & Email`, `Cluster 111`, `Cluster 81`, `Reset Project Script`, `Cluster 84`, `Admin Routes (Backend)`, `Cluster 86`, `Cluster 56`, `Auth Login & Profile Setup`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `Card()` connect `Web Admin Layout` to `School Auth Context`, `Mobile API Service Layer`, `Database Columns & Keys`, `Web Auth Contexts`, `Auth & Twilio OTP`, `Web API Index`, `Auth Login & Profile Setup`, `Competitions Routes & Recs`, `Themed Components & Hooks`, `Auth Register Screen`, `Historical Phone Login`, `Push Notifications`, `Reset Project Script`, `Cluster 56`, `Cluster 75`, `Cluster 81`, `Cluster 84`, `Cluster 86`, `Cluster 111`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `Brand` connect `Web UI Components` to `Web Auth API`, `School Auth Context`, `Mobile Tabs Misc`, `Cluster 101`, `Cluster 102`, `Cluster 100`, `Auth & Competitions Routes`, `Beyond Classroom PDF`, `Cluster 107`, `Cluster 85`, `Competition Detail Mobile`, `Profile Edit & Interests`, `Documents Backend`, `Cluster 91`, `Cluster 62`?**
