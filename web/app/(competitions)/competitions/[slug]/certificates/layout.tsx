...
// Student guard for the certificates page — mirrors the dashboard/materials
// layout: a logged-in non-admin participant only; admins are bounced.
...
export default function CompetitionCertificatesLayout({ children }: { children: ReactNode }) {
